...
<Components>
  ...
  <Sub SUB1 1 250 160 -26 38 0 0 "/home/vvk/qucs/examples/ngspice/quarz.sch" 1 "8863k" 1 "0.01406" 1 "6.5p" 1 "0" 1>
...
<Diagrams>
  <Rect 508 475 264 215 3 #c0c0c0 1 01 1 8.8e+06 20000 9e+06 1 -0.00166302 0.005 0.0183142 1 -1 0.5 1 315 0 225 "" "" "">
	<"quarz_test_xyce:ac.V(OUT)" #0000ff 0 3 0 0 0>
  </Rect>
  <Rect 114 671 301 191 3 #c0c0c0 1 00 1 8.8e+06 50000 9e+06 1 -300 1 -10 1 -1 0.5 1 315 0 225 "" "" "">
	<"quarz_test_ngspice:ac.k" #ff0000 0 3 0 0 0>
  </Rect>
</Diagrams>
<Paintings>
  <Text 190 10 12 #000000 0 "This example illustrates how to use subcircuits with Ngspice and Xyce.\nYou need to specify absolute location of subcircuit "quarz.sch".\nThis subcircuit is in the same directory where is this example.">
</Paintings>
