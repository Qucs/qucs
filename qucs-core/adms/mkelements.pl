...
open FILE,">$top_srcdir/adms.h"; print FILE $adms_h; close FILE;
print "$top_srcdir/adms.h: created\n";
...
$adms_c.="  adms_message_fatal((\"%s:%i: please report to r29173\@gmail.com\\n\",__FILE__,__LINE__))\n";
$adms_c.="  return NULL;\n";
$adms_c.="}\n";
...
$adms_c.="  adms_message_fatal_continue((\"%s:%i: internal error - should not be reached\\n\",__FILE__,__LINE__))\n";
$adms_c.="  adms_message_fatal_continue((\"%s:%i: please report to r29173\@gmail.com\\n\",__FILE__,__LINE__))\n";
$adms_c.="  adms_message_fatal((\"see %s\\n\",adms_transform_uid(mytransform)))\n";
$adms_c.="  return NULL;\n";
$adms_c.="}\n";
...
open FILE,">$top_srcdir/adms.c"; print FILE $adms_c; close FILE;
print "$top_srcdir/adms.c: created\n";
...
open admstpath_dtd,">$top_srcdir/admstpath.dtd";
my$dtd=q[
...
close admstpath_dtd;
print "$top_srcdir/admstpath.dtd: created\n";

open admstpathYacc_h,">$top_srcdir/admstpathYacc.h";
...
print "$top_srcdir/admstpathYacc.h: created\n";


open admstpathYacc_y,">$top_srcdir/admstpathYacc.y";
...
foreach($admstpathxml->findnodes("//constant|//regexp"))
{
  ...
  elsif(xvalue($_)=~/\w$/)
  {
    ...
    print admstpathYacc_y "  else if(!strncmp(t,\"".xvalue($_)."\",$len)&&!isalpha((int)*(t+$len)))\n";
...
print "$top_srcdir/admstpathYacc.y: created\n";
