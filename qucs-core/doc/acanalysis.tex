...
in SPICE). An often used model consists of finite inductances and
a not perfect coupling (straw inductance). This model has three
parameters: Inductance of primary coil $L_1$, inductance of secondary
coil $L_2$ and coupling factor $k=0...1$.\\
...
\begin{equation}
\text{turn ratio:}  \qquad  T = \sqrt{\frac{L_1}{L_2}}
\end{equation}
\begin{equation}
\text{mutual inductance:}  \qquad  M = k\cdot L_1
\end{equation}
\begin{equation}
\text{primary inductance:}  \qquad  L_{1,new} = L_1 - M
\end{equation}
\begin{equation}
\text{secondary inductance:}  \qquad  L_{2,new} = L_2 - \frac{M}{N^2}
\end{equation}
