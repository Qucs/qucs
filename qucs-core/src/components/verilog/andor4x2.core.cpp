/*
 * andor4x2.core.cpp - device implementations for andor4x2 module
 *
...
/* Device constructor. */
andor4x2::andor4x2() : circuit (11)
{
  type = CIR_andor4x2;
}

/* Initialization of model. */
void andor4x2::initModel (void)
{
...
void andor4x2::restartDC (void)
{
}

/* Initialize Verilog-AMS code. */
void andor4x2::initVerilog (void)
{
...
void andor4x2::loadVariables (void)
{
...
void andor4x2::initializeModel (void)
{
#if defined(_DYNAMIC)
#endif
{
...
void andor4x2::saveOperatingPoints (void)
{
  // save global instance operating points
}

/* Load operating points. */
void andor4x2::loadOperatingPoints (void)
{
}

/* Calculate operating points. */
void andor4x2::calcOperatingPoints (void)
{
}

/* Initialization of AC analysis. */
void andor4x2::initAC (void)
{
  allocMatrixMNA ();
}

/* Perform AC calculations. */
void andor4x2::calcAC (nr_double_t frequency)
{
  setMatrixY (calcMatrixY (frequency));
}

/* Compute Y-matrix for AC analysis. */
matrix andor4x2::calcMatrixY (nr_double_t frequency)
{
  _freq = frequency;
  saveOperatingPoints ();
  matrix y (11);
...
void andor4x2::initSP (void)
{
  allocMatrixS ();
}

/* Perform S-parameter calculations. */
void andor4x2::calcSP (nr_double_t frequency)
{
  setMatrixS (ytos (calcMatrixY (frequency)));   
}

/* Initialization of transient analysis. */
void andor4x2::initTR (void)
{
  setStates (2 * 11 * 11);
  initDC ();
}
...
void andor4x2::calcTR (nr_double_t)
{
  doHB = 0;
  doAC = 1;
  doTR = 1;
...
matrix andor4x2::calcMatrixCy (nr_double_t frequency) 
{
  _freq = frequency;
  matrix cy (11);
