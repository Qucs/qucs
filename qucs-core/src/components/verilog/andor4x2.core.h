/*
 * andor4x2.core.h - device class definitions for andor4x2 module
 *
...
#ifndef __andor4x2_H__
#define __andor4x2_H__

class andor4x2 : public qucs::circuit
{
 public:
  CREATOR (andor4x2);
