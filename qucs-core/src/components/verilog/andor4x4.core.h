/*
 * andor4x4.core.h - device class definitions for andor4x4 module
 *
...
#ifndef __andor4x4_H__
#define __andor4x4_H__

class andor4x4 : public qucs::circuit
{
 public:
  CREATOR (andor4x4);
