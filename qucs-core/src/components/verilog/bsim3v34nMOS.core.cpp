/*
 * bsim3v34nMOS.core.cpp - device implementations for bsim3v34nMOS module
 *
...
#include "component.h"
#include "device.h"
#include "bsim3v34nMOS.core.h"

#ifndef CIR_bsim3v34nMOS
#define CIR_bsim3v34nMOS -1
#endif
...
#define _modelname              "bsim3v34nMOS"
...
/* Device constructor. */
bsim3v34nMOS::bsim3v34nMOS() : circuit (6)
{
  type = CIR_bsim3v34nMOS;
}

/* Initialization of model. */
void bsim3v34nMOS::initModel (void)
{
...
void bsim3v34nMOS::restartDC (void)
{
}

/* Initialize Verilog-AMS code. */
void bsim3v34nMOS::initVerilog (void)
{
...
void bsim3v34nMOS::loadVariables (void)
{
...
void bsim3v34nMOS::initializeModel (void)
{
}

/* Evaluate Verilog-AMS equations in instance initialization. */
void bsim3v34nMOS::initializeInstance (void)
{
}

/* Evaluate Verilog-AMS equations in initial step. */
void bsim3v34nMOS::initialStep (void)
{
...
void bsim3v34nMOS::finalStep (void)
{
}

/* Evaluate Verilog-AMS equations in analog block. */
void bsim3v34nMOS::calcVerilog (void)
{
...
void bsim3v34nMOS::saveOperatingPoints (void)
{
...
void bsim3v34nMOS::loadOperatingPoints (void)
{
}

/* Calculate operating points. */
void bsim3v34nMOS::calcOperatingPoints (void)
{
}

/* Initialization of AC analysis. */
void bsim3v34nMOS::initAC (void)
{
  allocMatrixMNA ();
}

/* Perform AC calculations. */
void bsim3v34nMOS::calcAC (nr_double_t frequency)
{
  setMatrixY (calcMatrixY (frequency));
}

/* Compute Y-matrix for AC analysis. */
matrix bsim3v34nMOS::calcMatrixY (nr_double_t frequency)
{
  _freq = frequency;
  saveOperatingPoints ();
  matrix y (6);
...
void bsim3v34nMOS::initSP (void)
{
  allocMatrixS ();
}

/* Perform S-parameter calculations. */
void bsim3v34nMOS::calcSP (nr_double_t frequency)
{
  setMatrixS (ytos (calcMatrixY (frequency)));   
}

/* Initialization of transient analysis. */
void bsim3v34nMOS::initTR (void)
{
  setStates (2 * 6 * 6);
  initDC ();
}
...
void bsim3v34nMOS::calcTR (nr_double_t)
{
  doHB = 0;
  doAC = 1;
  doTR = 1;
...
matrix bsim3v34nMOS::calcMatrixCy (nr_double_t frequency) 
{
  _freq = frequency;
  matrix cy (6);
