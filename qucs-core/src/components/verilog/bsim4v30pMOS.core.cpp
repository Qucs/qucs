/*
 * bsim4v30pMOS.core.cpp - device implementations for bsim4v30pMOS module
 *
...
#include "component.h"
#include "device.h"
#include "bsim4v30pMOS.core.h"

#ifndef CIR_bsim4v30pMOS
#define CIR_bsim4v30pMOS -1
#endif
...
#define _modelname              "bsim4v30pMOS"
...
/* Device constructor. */
bsim4v30pMOS::bsim4v30pMOS() : circuit (11)
{
  type = CIR_bsim4v30pMOS;
}

/* Initialization of model. */
void bsim4v30pMOS::initModel (void)
{
...
void bsim4v30pMOS::restartDC (void)
{
}

/* Initialize Verilog-AMS code. */
void bsim4v30pMOS::initVerilog (void)
{
...
void bsim4v30pMOS::loadVariables (void)
{
...
void bsim4v30pMOS::initializeModel (void)
{
double dmdgeff;
double dmcieff;
double dmcgeff;
...
{
pseff=bsim4v30pMOS_get_ps(nf,geomod,imin,weffcj,dmcgeff,dmcieff,dmdgeff);
}
if
((pd>0.0))
{
...
{
pdeff=bsim4v30pMOS_get_pd(nf,geomod,imin,weffcj,dmcgeff,dmcieff,dmdgeff);
}
if
((as>0.0))
{
...
{
aseff=bsim4v30pMOS_get_as(nf,geomod,imin,weffcj,dmcgeff,dmcieff,dmdgeff);
}
if
((ad>0.0))
{
...
{
adeff=bsim4v30pMOS_get_ad(nf,geomod,imin,weffcj,dmcgeff,dmcieff,dmdgeff);
}
if
((nrs!=(-99.0)))
{
...
((rgeomod>0))
{
gsdiff=bsim4v30pMOS_get_rtot(nf,geomod,rgeomod,imin,weffcj,rsh,dmcgeff,dmcieff,dmdgeff,1);
}
else
{
gsdiff=0.0;
...
((rgeomod>0))
{
gddiff=bsim4v30pMOS_get_rtot(nf,geomod,rgeomod,imin,weffcj,rsh,dmcgeff,dmcieff,dmdgeff,0);
}
else
{
gddiff=0.0;
...
((diomod)==(1))
{
vjsmfwd=bsim4v30pMOS_get_vjm(nvtms,ijthsfwd,isbs,0.0);
{
...
vjsmfwd=bsim4v30pMOS_get_vjm(nvtms,ijthsfwd,isbs,xexpbvs);
{
double m00_exp(d00_exp0,(vjsmfwd/nvtms))
#if defined(_DERIVATE)
t0_Vgatep_sourcep=0.0;
...
((diomod)==(1))
{
vjdmfwd=bsim4v30pMOS_get_vjm(nvtmd,ijthdfwd,isbd,0.0);
{
...
vjsmfwd=bsim4v30pMOS_get_vjm(nvtmd,ijthdfwd,isbd,xexpbvd);
{
double m00_exp(d00_exp0,(vjdmfwd/nvtmd))
#if defined(_DERIVATE)
t0_Vgatep_sourcep=0.0;
...
void bsim4v30pMOS::initializeInstance (void)
{
}

/* Evaluate Verilog-AMS equations in initial step. */
void bsim4v30pMOS::initialStep (void)
{
}

/* Evaluate Verilog-AMS equations in final step. */
void bsim4v30pMOS::finalStep (void)
{
}

/* Evaluate Verilog-AMS equations in analog block. */
void bsim4v30pMOS::calcVerilog (void)
{
...
void bsim4v30pMOS::saveOperatingPoints (void)
{
  // save global instance operating points
}

/* Load operating points. */
void bsim4v30pMOS::loadOperatingPoints (void)
{
}

/* Calculate operating points. */
void bsim4v30pMOS::calcOperatingPoints (void)
{
}

/* Initialization of AC analysis. */
void bsim4v30pMOS::initAC (void)
{
  allocMatrixMNA ();
}

/* Perform AC calculations. */
void bsim4v30pMOS::calcAC (nr_double_t frequency)
{
  setMatrixY (calcMatrixY (frequency));
}

/* Compute Y-matrix for AC analysis. */
matrix bsim4v30pMOS::calcMatrixY (nr_double_t frequency)
{
  _freq = frequency;
  saveOperatingPoints ();
  matrix y (11);
...
void bsim4v30pMOS::initSP (void)
{
  allocMatrixS ();
}

/* Perform S-parameter calculations. */
void bsim4v30pMOS::calcSP (nr_double_t frequency)
{
  setMatrixS (ytos (calcMatrixY (frequency)));   
}

/* Initialization of transient analysis. */
void bsim4v30pMOS::initTR (void)
{
  setStates (2 * 11 * 11);
  initDC ();
}
...
void bsim4v30pMOS::calcTR (nr_double_t)
{
  doHB = 0;
  doAC = 1;
  doTR = 1;
...
matrix bsim4v30pMOS::calcMatrixCy (nr_double_t frequency) 
{
  _freq = frequency;
  matrix cy (11);
