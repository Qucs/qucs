/*
 * comp_1bit.core.h - device class definitions for comp_1bit module
 *
...
#ifndef __comp_1bit_H__
#define __comp_1bit_H__

class comp_1bit : public qucs::circuit
{
 public:
  CREATOR (comp_1bit);
