/*
 * comp_2bit.core.h - device class definitions for comp_2bit module
 *
...
#ifndef __comp_2bit_H__
#define __comp_2bit_H__

class comp_2bit : public qucs::circuit
{
 public:
  CREATOR (comp_2bit);
