/*
 * dmux2to4.core.h - device class definitions for dmux2to4 module
 *
...
#ifndef __dmux2to4_H__
#define __dmux2to4_H__

class dmux2to4 : public qucs::circuit
{
 public:
  CREATOR (dmux2to4);
