/*
 * gatedDlatch.core.h - device class definitions for gatedDlatch module
 *
...
#ifndef __gatedDlatch_H__
#define __gatedDlatch_H__

class gatedDlatch : public qucs::circuit
{
 public:
  CREATOR (gatedDlatch);
