/*
 * greytobinary4bit.core.h - device class definitions for greytobinary4bit module
 *
...
#ifndef __greytobinary4bit_H__
#define __greytobinary4bit_H__

class greytobinary4bit : public qucs::circuit
{
 public:
  CREATOR (greytobinary4bit);
