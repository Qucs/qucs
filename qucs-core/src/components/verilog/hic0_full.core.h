/*
 * hic0_full.core.h - device class definitions for hic0_full module
 *
...
#ifndef __hic0_full_H__
#define __hic0_full_H__

class hic0_full : public qucs::circuit
{
 public:
  CREATOR (hic0_full);
