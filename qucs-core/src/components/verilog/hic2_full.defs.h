/*
 * hic2_full.defs.h - device definition header
 *
...
#ifndef __hic2_full_DEFS_H__
#define __hic2_full_DEFS_H__
...
PROP_REQ [] = {
  ...
  { "fgeo", PROP_REAL, { 0.6557, PROP_NO_STR }, PROP_RNGII (0, 1) },
  { "fdqr0", PROP_REAL, { 0.0, PROP_NO_STR }, PROP_RNGII (0, 1) },
...
// device definition
struct define_t hic2_full::cirdef =
  { "hic2_full",
    5, PROP_COMPONENT, PROP_NO_SUBSTRATE, PROP_NONLINEAR, PROP_DEF };

#endif /* __hic2_full_DEFS_H__ */
