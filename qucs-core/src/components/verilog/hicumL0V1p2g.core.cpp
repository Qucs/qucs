/*
 * hicumL0V1p2g.core.cpp - device implementations for hicumL0V1p2g module
 *
...
#include "component.h"
#include "device.h"
#include "hicumL0V1p2g.core.h"

#ifndef CIR_hicumL0V1p2g
#define CIR_hicumL0V1p2g -1
#endif
...
#define _modelname              "hicumL0V1p2g"
...
/* Device constructor. */
hicumL0V1p2g::hicumL0V1p2g() : circuit (8)
{
  type = CIR_hicumL0V1p2g;
}

/* Initialization of model. */
void hicumL0V1p2g::initModel (void)
{
...
void hicumL0V1p2g::restartDC (void)
{
}

/* Initialize Verilog-AMS code. */
void hicumL0V1p2g::initVerilog (void)
{
...
void hicumL0V1p2g::loadVariables (void)
{
  ...
  fiqf = getPropertyInteger ("fiqf");
  iqr = getPropertyDouble ("iqr");
  iqfh = getPropertyDouble ("iqfh");
  iqfe = getPropertyDouble ("iqfe");
  ...
  delte = getPropertyDouble ("delte");
  deltc = getPropertyDouble ("deltc");
  zetaver = getPropertyDouble ("zetaver");
  zetavef = getPropertyDouble ("zetavef");
  ibhrec = getPropertyDouble ("ibhrec");
}
...
void hicumL0V1p2g::initializeModel (void)
{
{
if
(_param_given("npn"))
...
void hicumL0V1p2g::initializeInstance (void)
{
}

/* Evaluate Verilog-AMS equations in initial step. */
void hicumL0V1p2g::initialStep (void)
{
}

/* Evaluate Verilog-AMS equations in final step. */
void hicumL0V1p2g::finalStep (void)
{
}

/* Evaluate Verilog-AMS equations in analog block. */
void hicumL0V1p2g::calcVerilog (void)
{
...
double flicker_Pwr_Vci_ei;
double flicker_Pwr_Vbi_ci;
double flicker_Pwr_Vb_ci;
#endif
double twoq;
double fourkt;
#if defined(_DERIVATE)
...
double qmB;
#if defined(_DERIVATE)
double qmB_Vtnode_GND;
double qmB_Vbi_ei;
#endif
double qm0;
#if defined(_DERIVATE)
double qm0_Vtnode_GND;
double qm0_Vbi_ei;
double qm0_Vbi_ci;
double qm0_Vb_ci;
#endif
...
double Dfic;
#if defined(_DERIVATE)
double Dfic_Vtnode_GND;
#endif
double qjcidc;
#if defined(_DERIVATE)
double qjcidc_Vbi_ei;
double qjcidc_Vbi_ci;
double qjcidc_Vtnode_GND;
double qjcidc_Vb_ci;
#endif
double Gjei;
#if defined(_DERIVATE)
double Gjei_Vtnode_GND;
double Gjei_Vbi_ei;
double Gjei_Vbi_ci;
double Gjei_Vb_ci;
#endif
double Dfie;
#if defined(_DERIVATE)
double Dfie_Vtnode_GND;
#endif
double qjedc;
#if defined(_DERIVATE)
double qjedc_Vtnode_GND;
double qjedc_Vbi_ei;
double qjedc_Vbi_ci;
double qjedc_Vb_ci;
#endif
double Vbiei_l;
#if defined(_DERIVATE)
double Vbiei_l_Vbi_ci;
double Vbiei_l_Vtnode_GND;
double Vbiei_l_Vb_ci;
double Vbiei_l_Vbi_ei;
#endif
double sqx;
#if defined(_DERIVATE)
double sqx_Vbi_ei;
double sqx_Vbi_ci;
double sqx_Vtnode_GND;
double sqx_Vb_ci;
#endif
double aa;
#if defined(_DERIVATE)
...
double expiqf;
#if defined(_DERIVATE)
double expiqf_Vtnode_GND;
#endif
double mrgt;
#if defined(_DERIVATE)
double mrgt_Vtnode_GND;
#endif
double iscs_t;
#if defined(_DERIVATE)
...
#if defined(_DERIVATE)
mrgt_Vtnode_GND=(-(-Tnom*Tdev_Vtnode_GND/Tdev/Tdev));
#endif
mrgt=(1-(Tnom/Tdev));
{
double m00_exp(d00_exp0,(mrgt*zetaiqf))
#if defined(_DERIVATE)
#define d10_exp0 d00_exp0
#endif
#if defined(_DERIVATE)
expiqf_Vtnode_GND=mrgt_Vtnode_GND*zetaiqf*d10_exp0;
#endif
expiqf=d00_exp0;
}
#if defined(_DERIVATE)
iqf_t_Vtnode_GND=(iqf*expiqf_Vtnode_GND);
#endif
iqf_t=(iqf*expiqf);
#if defined(_DERIVATE)
iqr_t_Vtnode_GND=(iqr*expiqf_Vtnode_GND);
#endif
iqr_t=(iqr*expiqf);
#if defined(_DERIVATE)
iqfh_t_Vtnode_GND=(iqfh*expiqf_Vtnode_GND);
#endif
iqfh_t=(iqfh*expiqf);
#if defined(_DERIVATE)
iqfe_t_Vtnode_GND=(iqfe*expiqf_Vtnode_GND);
#endif
iqfe_t=(iqfe*expiqf);
{
double m00_exp(d00_exp0,(mrgt*zetaver))
#if defined(_DERIVATE)
#define d10_exp0 d00_exp0
#endif
#if defined(_DERIVATE)
ver_t_Vtnode_GND=(ver*mrgt_Vtnode_GND*zetaver*d10_exp0);
#endif
ver_t=(ver*d00_exp0);
}
{
double m00_exp(d00_exp0,(mrgt*zetavef))
#if defined(_DERIVATE)
#define d10_exp0 d00_exp0
#endif
#if defined(_DERIVATE)
vef_t_Vtnode_GND=(vef*mrgt_Vtnode_GND*zetavef*d10_exp0);
#endif
vef_t=(vef*d00_exp0);
}
{
double m00_exp(d00_exp0,((zetact*ln_qtt0)+(((vgb/vt0)-zetaiqf)*mrgt)))
#if defined(_DERIVATE)
#define d10_exp0 d00_exp0
#endif
#if defined(_DERIVATE)
is_t_Vtnode_GND=(is*((zetact*ln_qtt0_Vtnode_GND)+(((vgb/vt0)-zetaiqf)*mrgt_Vtnode_GND))*d10_exp0);
#endif
is_t=(is*d00_exp0);
}
arg=((0.5*vde)/vt0);
...
#endif
#if defined(_DERIVATE)
favl_t_Vtnode_GND=(favl*(alkav*dT_Vtnode_GND)*d10_exp0);
#endif
...
#endif
#if defined(_DERIVATE)
qavl_t_Vtnode_GND=(qavl*(aleav*dT_Vtnode_GND)*d10_exp0);
#endif
qavl_t=(qavl*d00_exp0);
}
#if defined(_DERIVATE)
kavl_t_Vtnode_GND=((favl_t_Vtnode_GND*vdci_t)+(favl_t*vdci_t_Vtnode_GND));
#endif
kavl_t=(favl_t*vdci_t);
#if defined(_DERIVATE)
eavl_t_Vtnode_GND=((qavl_t_Vtnode_GND*(cjci0_t*vdci_t)-qavl_t*((cjci0_t_Vtnode_GND*vdci_t)+(cjci0_t*vdci_t_Vtnode_GND)))/(cjci0_t*vdci_t)/(cjci0_t*vdci_t));
#endif
...
y_Vb_ci=(-((x_Vb_ci*d00_logE0)+(x*(-(v_j_Vb_ci/vdci_t))*d10_logE0))*d10_exp1);
#endif
y=(1.0-d00_exp1);
}
#if defined(_DYNAMIC)
...
qjcx_Vb_ci=(((((cjcx0_t_i*vdci_t)*y_Vb_ci)*x-((cjcx0_t_i*vdci_t)*y)*x_Vb_ci)/x/x)+((2.4*cjcx0_t_i)*(Vbci_Vb_ci-v_j_Vb_ci)));
#endif
...
y_Vci_ei=0.0;
y_Vbi_ei=0.0;
y_Vbi_ci=(-((x_Vbi_ci*d00_logE0)+(x*(-(v_j_Vbi_ci/vdcx_t))*d10_logE0))*d10_exp1);
y_Vtnode_GND=(-((x_Vtnode_GND*d00_logE0)+(x*(-((v_j_Vtnode_GND*vdcx_t-v_j*vdcx_t_Vtnode_GND)/vdcx_t/vdcx_t))*d10_logE0))*d10_exp1);
y_Vb_ci=(-((x_Vb_ci*d00_logE0)+(x*(-(v_j_Vb_ci/vdcx_t))*d10_logE0))*d10_exp1);
#endif
y=(1.0-d00_exp1);
}
#if defined(_DYNAMIC)
#if defined(_DERIVATE)
qjcxi_Vbi_ci=(((((cjcx0_t_ii*vdcx_t)*y_Vbi_ci)*x-((cjcx0_t_ii*vdcx_t)*y)*x_Vbi_ci)/x/x)+((2.4*cjcx0_t_ii)*(Vbici_Vbi_ci-v_j_Vbi_ci)));
...
qjcxi_Vb_ci=(((((cjcx0_t_ii*vdcx_t)*y_Vb_ci)*x-((cjcx0_t_ii*vdcx_t)*y)*x_Vb_ci)/x/x)+((2.4*cjcx0_t_ii)*(-v_j_Vb_ci)));
#endif
...
#if defined(_DYNAMIC)
#if defined(_DERIVATE)
qjcx_Vbi_ci=(((((cjcx0_t_i*vdcx_t)*y_Vbi_ci)*x-((cjcx0_t_i*vdcx_t)*y)*x_Vbi_ci)/x/x)+((2.4*cjcx0_t_i)*(-v_j_Vbi_ci)));
...
qjcx_Vb_ci=(((((cjcx0_t_i*vdcx_t)*y_Vb_ci)*x-((cjcx0_t_i*vdcx_t)*y)*x_Vb_ci)/x/x)+((2.4*cjcx0_t_i)*(Vbci_Vb_ci-v_j_Vb_ci)));
#endif
...
y_Vci_ei=0.0;
y_Vbi_ei=0.0;
y_Vbi_ci=(-((x_Vbi_ci*d00_logE0)+(x*(-(v_j_Vbi_ci/vdci_t))*d10_logE0))*d10_exp1);
y_Vtnode_GND=(-((x_Vtnode_GND*d00_logE0)+(x*(-((v_j_Vtnode_GND*vdci_t-v_j*vdci_t_Vtnode_GND)/vdci_t/vdci_t))*d10_logE0))*d10_exp1);
y_Vb_ci=(-((x_Vb_ci*d00_logE0)+(x*(-(v_j_Vb_ci/vdci_t))*d10_logE0))*d10_exp1);
#endif
y=(1.0-d00_exp1);
...
#if defined(_DERIVATE)
qjci_Vbi_ci=(((((cjci0_t_ii*vdci_t)*y_Vbi_ci)*x-((cjci0_t_ii*vdci_t)*y)*x_Vbi_ci)/x/x)+((2.4*cjci0_t_ii)*(Vbici_Vbi_ci-v_j_Vbi_ci)));
...
qjci_Vb_ci=(((((cjci0_t_ii*vdci_t)*y_Vb_ci)*x-((cjci0_t_ii*vdci_t)*y)*x_Vb_ci)/x/x)+((2.4*cjci0_t_ii)*(-v_j_Vb_ci)));
#endif
...
#endif
#if defined(_DERIVATE)
occ_Vbi_ci=((((1*((-zci)*(-(v_j_Vbi_ci/vdci_t))*d10_logE0)*d10_exp1)*dvj)+((1*d00_exp1)*dvj_Vbi_ci))+((2.4*1)*(-dvj_Vbi_ci)));
occ_Vtnode_GND=((((1*((-zci)*(-((v_j_Vtnode_GND*vdci_t-v_j*vdci_t_Vtnode_GND)/vdci_t/vdci_t))*d10_logE0)*d10_exp1)*dvj)+((1*d00_exp1)*dvj_Vtnode_GND))+((2.4*1)*(-dvj_Vtnode_GND)));
occ_Vb_ci=((((1*((-zci)*(-(v_j_Vb_ci/vdci_t))*d10_logE0)*d10_exp1)*dvj)+((1*d00_exp1)*dvj_Vb_ci))+((2.4*1)*(-dvj_Vb_ci)));
#endif
occ=(((1*d00_exp1)*dvj)+((2.4*1)*(1-dvj)));
}
}
else
{
...
#if defined(_DERIVATE)
cc_Vbi_ci=(-1*occ_Vbi_ci/occ/occ);
cc_Vtnode_GND=(-1*occ_Vtnode_GND/occ/occ);
cc_Vb_ci=(-1*occ_Vb_ci/occ/occ);
#endif
cc=(1/occ);
#if defined(_DERIVATE)
tf0_Vtnode_GND=((t0_t_Vtnode_GND+(dt0h*cc_Vtnode_GND))+(tbvl*occ_Vtnode_GND));
tf0_Vbi_ci=((dt0h*cc_Vbi_ci)+(tbvl*occ_Vbi_ci));
tf0_Vb_ci=((dt0h*cc_Vb_ci)+(tbvl*occ_Vb_ci));
#endif
...
#endif
#if defined(_DERIVATE)
cT_cT0_Vtnode_GND=(1*(zedc*(-vdedc*vdedc_t_Vtnode_GND/vdedc_t/vdedc_t)*d10_logE0)*d10_exp1);
#endif
cT_cT0=(1*d00_exp1);
}
#if defined(_DERIVATE)
...
{
double m00_logE(d00_logE0,(vdedc/vdedc_t))
double m00_exp(d00_exp1,((1-zedc)*d00_logE0))
#if defined(_DERIVATE)
double m10_logE(d10_logE0,d00_logE0,(vdedc/vdedc_t))
#define d10_exp1 d00_exp1
#endif
#if defined(_DERIVATE)
expv_Vtnode_GND=((1-zedc)*(-vdedc*vdedc_t_Vtnode_GND/vdedc_t/vdedc_t)*d10_logE0)*d10_exp1;
#endif
expv=d00_exp1;
}
#if defined(_DERIVATE)
...
aa_Vbi_ci=0.0;
aa_Vb_ci=0.0;
aa_Vtnode_GND=(-(delte*(-expv_Vtnode_GND)));
#endif
aa=(1-(delte*(1-expv)));
#if defined(_DERIVATE)
aa_Vci_ei=0.0;
...
aa_Vbi_ci=0.0;
aa_Vb_ci=0.0;
aa_Vtnode_GND=(aa_Vtnode_GND+(((((1-a_bpt)*(1-zedc))*ver_t_Vtnode_GND)*expv)+((((1-a_bpt)*(1-zedc))*ver_t)*expv_Vtnode_GND)));
#endif
aa=(aa+((((1-a_bpt)*(1-zedc))*ver_t)*expv));
{
double m00_fabs(d00_fabs0,aa)
double m00_logE(d00_logE1,d00_fabs0)
double m00_exp(d00_exp2,(d00_logE1/(1-zedc)))
#if defined(_DERIVATE)
double m10_fabs(d10_fabs0,d00_fabs0,aa)
double m10_logE(d10_logE1,d00_logE1,d00_fabs0)
...
aa_Vbi_ci=0.0;
aa_Vb_ci=0.0;
aa_Vtnode_GND=(aa_Vtnode_GND*d10_fabs0*d10_logE1/(1-zedc))*d10_exp2;
#endif
aa=d00_exp2;
}
#if defined(_DERIVATE)
...
vr_Vs_ci=0.0;
vr_Vbi_ci=0.0;
vr_Vtnode_GND=((vdedc_t_Vtnode_GND*(1-aa))+(vdedc_t*(-aa_Vtnode_GND)));
vr_Vb_ci=0.0;
#endif
vr=(vdedc_t*(1-aa));
#if defined(_DERIVATE)
x_Vci_ei=0.0;
x_Vbi_ei=((Vbiei_Vbi_ei-vr_Vbi_ei)/a_bpt);
x_Vbi_ci=((-vr_Vbi_ci)/a_bpt);
x_Vtnode_GND=((-vr_Vtnode_GND)/a_bpt);
x_Vb_ci=((-vr_Vb_ci)/a_bpt);
#endif
x=((Vbiei-vr)/a_bpt);
{
double m00_sqrt(d00_sqrt0,((x*x)+1.921812))
#if defined(_DERIVATE)
double m10_sqrt(d10_sqrt0,d00_sqrt0,((x*x)+1.921812))
#endif
#if defined(_DERIVATE)
sqx_Vbi_ei=((x_Vbi_ei*x)+(x*x_Vbi_ei))*d10_sqrt0;
sqx_Vbi_ci=((x_Vbi_ci*x)+(x*x_Vbi_ci))*d10_sqrt0;
sqx_Vtnode_GND=((x_Vtnode_GND*x)+(x*x_Vtnode_GND))*d10_sqrt0;
sqx_Vb_ci=((x_Vb_ci*x)+(x*x_Vb_ci))*d10_sqrt0;
#endif
sqx=d00_sqrt0;
}
#if defined(_DERIVATE)
Vbiei_l_Vbi_ci=(vr_Vbi_ci+((0.5*a_bpt)*(x_Vbi_ci+sqx_Vbi_ci)));
Vbiei_l_Vtnode_GND=(vr_Vtnode_GND+((0.5*a_bpt)*(x_Vtnode_GND+sqx_Vtnode_GND)));
Vbiei_l_Vb_ci=(vr_Vb_ci+((0.5*a_bpt)*(x_Vb_ci+sqx_Vb_ci)));
Vbiei_l_Vbi_ei=(vr_Vbi_ei+((0.5*a_bpt)*(x_Vbi_ei+sqx_Vbi_ei)));
#endif
...
#if defined(_DERIVATE)
Vbiei_l_Vbi_ci=0.0;
Vbiei_l_Vtnode_GND=0.0;
Vbiei_l_Vb_ci=0.0;
Vbiei_l_Vbi_ei=Vbiei_Vbi_ei;
#endif
Vbiei_l=Vbiei;
}
if
...
#if defined(_DERIVATE)
xvf_Vs_ci=0.0;
xvf_Vbi_ei=((-Vbiei_l_Vbi_ei)/VT);
xvf_Vbi_ci=((-Vbiei_l_Vbi_ci)/VT);
xvf_Vtnode_GND=(((vf_Vtnode_GND-Vbiei_l_Vtnode_GND)*VT-(vf-Vbiei_l)*VT_Vtnode_GND)/VT/VT);
xvf_Vb_ci=((-Vbiei_l_Vb_ci)/VT);
#endif
xvf=((vf-Vbiei_l)/VT);
{
double m00_sqrt(d00_sqrt0,((xvf*xvf)+1.921812))
...
y_Vs_ci=0.0;
y_Vci_ei=0.0;
y_Vbi_ei=(-((x_Vbi_ei*d00_logE0)+(x*(-(v_j_Vbi_ei/vdedc_t))*d10_logE0))*d10_exp1);
y_Vbi_ci=(-((x_Vbi_ci*d00_logE0)+(x*(-(v_j_Vbi_ci/vdedc_t))*d10_logE0))*d10_exp1);
y_Vtnode_GND=(-((x_Vtnode_GND*d00_logE0)+(x*(-((v_j_Vtnode_GND*vdedc_t-v_j*vdedc_t_Vtnode_GND)/vdedc_t/vdedc_t))*d10_logE0))*d10_exp1);
y_Vb_ci=(-((x_Vb_ci*d00_logE0)+(x*(-(v_j_Vb_ci/vdedc_t))*d10_logE0))*d10_exp1);
#endif
y=(1.0-d00_exp1);
}
#if defined(_DERIVATE)
qjedc_Vtnode_GND=(((((((cT_cT0_Vtnode_GND*vdedc_t)+(cT_cT0*vdedc_t_Vtnode_GND))*y)+((cT_cT0*vdedc_t)*y_Vtnode_GND))*x-((cT_cT0*vdedc_t)*y)*x_Vtnode_GND)/x/x)+((((ajedc_t_Vtnode_GND*cT_cT0)+(ajedc_t*cT_cT0_Vtnode_GND))*(Vbiei_l-v_j))+((ajedc_t*cT_cT0)*(Vbiei_l_Vtnode_GND-v_j_Vtnode_GND))));
qjedc_Vbi_ei=(((((cT_cT0*vdedc_t)*y_Vbi_ei)*x-((cT_cT0*vdedc_t)*y)*x_Vbi_ei)/x/x)+((ajedc_t*cT_cT0)*(Vbiei_l_Vbi_ei-v_j_Vbi_ei)));
qjedc_Vbi_ci=(((((cT_cT0*vdedc_t)*y_Vbi_ci)*x-((cT_cT0*vdedc_t)*y)*x_Vbi_ci)/x/x)+((ajedc_t*cT_cT0)*(Vbiei_l_Vbi_ci-v_j_Vbi_ci)));
qjedc_Vb_ci=(((((cT_cT0*vdedc_t)*y_Vb_ci)*x-((cT_cT0*vdedc_t)*y)*x_Vb_ci)/x/x)+((ajedc_t*cT_cT0)*(Vbiei_l_Vb_ci-v_j_Vb_ci)));
#endif
qjedc=((((cT_cT0*vdedc_t)*y)/x)+((ajedc_t*cT_cT0)*(Vbiei_l-v_j)));
}
else
{
#if defined(_DERIVATE)
qjedc_Vtnode_GND=0.0;
qjedc_Vbi_ei=0.0;
qjedc_Vbi_ci=0.0;
qjedc_Vb_ci=0.0;
#endif
...
{
double m00_logE(d00_logE0,(vdedc_t/vdedc))
double m00_exp(d00_exp1,((1-zedc)*d00_logE0))
#if defined(_DERIVATE)
double m10_logE(d10_logE0,d00_logE0,(vdedc_t/vdedc))
#define d10_exp1 d00_exp1
#endif
#if defined(_DERIVATE)
Dfie_Vtnode_GND=((delte*(-((1-zedc)*(vdedc_t_Vtnode_GND/vdedc)*d10_logE0)*d10_exp1))/(1-zedc));
#endif
Dfie=((delte*(1-d00_exp1))/(1-zedc));
}
#if defined(_DERIVATE)
Gjei_Vtnode_GND=(Dfie_Vtnode_GND+(qjedc_Vtnode_GND/vdedc));
Gjei_Vbi_ei=(qjedc_Vbi_ei/vdedc);
Gjei_Vbi_ci=(qjedc_Vbi_ci/vdedc);
Gjei_Vb_ci=(qjedc_Vb_ci/vdedc);
#endif
Gjei=(Dfie+(qjedc/vdedc));
{
double m00_logE(d00_logE0,(vdci_t/vdci))
double m00_exp(d00_exp1,((-zci)*d00_logE0))
#if defined(_DERIVATE)
double m10_logE(d10_logE0,d00_logE0,(vdci_t/vdci))
#define d10_exp1 d00_exp1
#endif
#if defined(_DERIVATE)
cT_cT0_Vtnode_GND=((-zci)*(vdci_t_Vtnode_GND/vdci)*d10_logE0)*d10_exp1;
#endif
cT_cT0=d00_exp1;
}
if
...
#if defined(_DERIVATE)
cmax_Vtnode_GND=(2.4*cT_cT0_Vtnode_GND);
#endif
cmax=(2.4*cT_cT0);
{
double m00_logE(d00_logE0,(vdci_t/vptci))
...
#endif
#if defined(_DERIVATE)
cr_Vtnode_GND=((cT_cT0_Vtnode_GND*d00_exp1)+(cT_cT0*((zci-zr)*(vdci_t_Vtnode_GND/vptci)*d10_logE0)*d10_exp1));
#endif
cr=(cT_cT0*d00_exp1);
}
#if defined(_DERIVATE)
...
qj1_Vbi_ei=0.0;
qj1_Vs_ci=0.0;
qj1_Vbi_ci=((cT_cT0*(-vdj2_Vbi_ci*ez*d10_exp0))/ez);
qj1_Vtnode_GND=(((cT_cT0_Vtnode_GND*(1.0-d00_exp0))+(cT_cT0*(-vdj2_Vtnode_GND*ez*d10_exp0)))/ez);
qj1_Vb_ci=((cT_cT0*(-vdj2_Vb_ci*ez*d10_exp0))/ez);
#endif
qj1=((cT_cT0*(1.0-d00_exp0))/ez);
}
{
double m00_exp(d00_exp0,(vdj1*ezr))
#if defined(_DERIVATE)
...
#if defined(_DERIVATE)
qjcidc_Vbi_ei=0.0;
qjcidc_Vbi_ci=(((qj1_Vbi_ci+qj2_Vbi_ci)-qj3_Vbi_ci)*vdci_t+(cmax*vj4_Vbi_ci));
qjcidc_Vtnode_GND=(((((qj1_Vtnode_GND+qj2_Vtnode_GND)-qj3_Vtnode_GND)*vdci_t)+(((qj1+qj2)-qj3)*vdci_t_Vtnode_GND))+((cmax_Vtnode_GND*vj4)+(cmax*vj4_Vtnode_GND)));
qjcidc_Vb_ci=(((qj1_Vb_ci+qj2_Vb_ci)-qj3_Vb_ci)*vdci_t+(cmax*vj4_Vb_ci));
#endif
qjcidc=((((qj1+qj2)-qj3)*vdci_t)+(cmax*vj4));
}
else
{
#if defined(_DERIVATE)
...
y_Vs_ci=0.0;
y_Vci_ei=0.0;
y_Vbi_ei=(-((x_Vbi_ei*d00_logE0)+(x*(-(v_j_Vbi_ei/vdci_t))*d10_logE0))*d10_exp1);
y_Vbi_ci=(-((x_Vbi_ci*d00_logE0)+(x*(-(v_j_Vbi_ci/vdci_t))*d10_logE0))*d10_exp1);
y_Vtnode_GND=(-((x_Vtnode_GND*d00_logE0)+(x*(-((v_j_Vtnode_GND*vdci_t-v_j*vdci_t_Vtnode_GND)/vdci_t/vdci_t))*d10_logE0))*d10_exp1);
y_Vb_ci=(-((x_Vb_ci*d00_logE0)+(x*(-(v_j_Vb_ci/vdci_t))*d10_logE0))*d10_exp1);
#endif
...
#if defined(_DERIVATE)
qjcidc_Vbi_ei=(((((cT_cT0*vdci_t)*y_Vbi_ei)*x-((cT_cT0*vdci_t)*y)*x_Vbi_ei)/x/x)+((2.4*cT_cT0)*(-v_j_Vbi_ei)));
qjcidc_Vbi_ci=(((((cT_cT0*vdci_t)*y_Vbi_ci)*x-((cT_cT0*vdci_t)*y)*x_Vbi_ci)/x/x)+((2.4*cT_cT0)*(Vbici_Vbi_ci-v_j_Vbi_ci)));
qjcidc_Vtnode_GND=(((((((cT_cT0_Vtnode_GND*vdci_t)+(cT_cT0*vdci_t_Vtnode_GND))*y)+((cT_cT0*vdci_t)*y_Vtnode_GND))*x-((cT_cT0*vdci_t)*y)*x_Vtnode_GND)/x/x)+(((2.4*cT_cT0_Vtnode_GND)*(Vbici-v_j))+((2.4*cT_cT0)*(-v_j_Vtnode_GND))));
qjcidc_Vb_ci=(((((cT_cT0*vdci_t)*y_Vb_ci)*x-((cT_cT0*vdci_t)*y)*x_Vb_ci)/x/x)+((2.4*cT_cT0)*(-v_j_Vb_ci)));
#endif
qjcidc=((((cT_cT0*vdci_t)*y)/x)+((2.4*cT_cT0)*(Vbici-v_j)));
}
else
{
#if defined(_DERIVATE)
...
{
double m00_logE(d00_logE0,(vdci_t/vdci))
double m00_exp(d00_exp1,((1-zci)*d00_logE0))
#if defined(_DERIVATE)
double m10_logE(d10_logE0,d00_logE0,(vdci_t/vdci))
#define d10_exp1 d00_exp1
#endif
#if defined(_DERIVATE)
Dfic_Vtnode_GND=((deltc*(-((1-zci)*(vdci_t_Vtnode_GND/vdci)*d10_logE0)*d10_exp1))/(1-zci));
#endif
Dfic=((deltc*(1-d00_exp1))/(1-zci));
}
#if defined(_DERIVATE)
Gjci_Vtnode_GND=(Dfic_Vtnode_GND+(qjcidc_Vtnode_GND/vdci));
Gjci_Vbi_ei=(qjcidc_Vbi_ei/vdci);
Gjci_Vbi_ci=(qjcidc_Vbi_ci/vdci);
Gjci_Vb_ci=(qjcidc_Vb_ci/vdci);
#endif
Gjci=(Dfic+(qjcidc/vdci));
#if defined(_DERIVATE)
qj_2_Vtnode_GND=(((Gjci_Vtnode_GND*vef_t-Gjci*vef_t_Vtnode_GND)/vef_t/vef_t)+((Gjei_Vtnode_GND*ver_t-Gjei*ver_t_Vtnode_GND)/ver_t/ver_t));
qj_2_Vbi_ei=((Gjci_Vbi_ei/vef_t)+(Gjei_Vbi_ei/ver_t));
qj_2_Vbi_ci=((Gjci_Vbi_ci/vef_t)+(Gjei_Vbi_ci/ver_t));
qj_2_Vb_ci=((Gjci_Vb_ci/vef_t)+(Gjei_Vb_ci/ver_t));
#endif
qj_2=((1+(Gjci/vef_t))+(Gjei/ver_t));
#if defined(_DERIVATE)
b_q_Vtnode_GND=(20*qj_2_Vtnode_GND);
b_q_Vbi_ei=(20*qj_2_Vbi_ei);
b_q_Vbi_ci=(20*qj_2_Vbi_ci);
b_q_Vb_ci=(20*qj_2_Vb_ci);
#endif
b_q=((20*qj_2)-1);
{
...
{
#if defined(_DERIVATE)
denom_iqf_Vtnode_GND=(fiqf*((tf0_Vtnode_GND*t0_t-tf0*t0_t_Vtnode_GND)/t0_t/t0_t));
denom_iqf_Vbi_ci=(fiqf*(tf0_Vbi_ci/t0_t));
denom_iqf_Vb_ci=(fiqf*(tf0_Vb_ci/t0_t));
#endif
...
#if defined(_DERIVATE)
ickr_Vtnode_GND=iqr_t_Vtnode_GND;
#endif
ickr=iqr_t;
#if defined(_DERIVATE)
...
ick_Vbi_ei=(((vceff*(0.5*(x_Vbi_ei+((x_Vbi_ei*x)+(x*x_Vbi_ei))*d10_sqrt0)))/rci0_t)/d00_sqrt1);
ick_Vbi_ci=(((vceff*(0.5*(x_Vbi_ci+((x_Vbi_ci*x)+(x*x_Vbi_ci))*d10_sqrt0)))/rci0_t)/d00_sqrt1);
ick_Vb_ci=(((vceff*(0.5*(x_Vb_ci+((x_Vb_ci*x)+(x*x_Vb_ci))*d10_sqrt0)))/rci0_t)/d00_sqrt1);
#endif
...
{
{
double m00_logE(d00_logE0,((itfi*(itfi/ick))/iqfe_t))
double m00_exp(d00_exp1,(0.6666*d00_logE0))
#if defined(_DERIVATE)
double m10_logE(d10_logE0,d00_logE0,((itfi*(itfi/ick))/iqfe_t))
#define d10_exp1 d00_exp1
#endif
#if defined(_DERIVATE)
qmE_Vtnode_GND=(0.6666*((((itfi_Vtnode_GND*(itfi/ick))+(itfi*((itfi_Vtnode_GND*ick-itfi*ick_Vtnode_GND)/ick/ick)))*iqfe_t-(itfi*(itfi/ick))*iqfe_t_Vtnode_GND)/iqfe_t/iqfe_t)*d10_logE0)*d10_exp1;
qmE_Vbi_ei=(0.6666*(((itfi_Vbi_ei*(itfi/ick))+(itfi*((itfi_Vbi_ei*ick-itfi*ick_Vbi_ei)/ick/ick)))/iqfe_t)*d10_logE0)*d10_exp1;
qmE_Vci_ei=(0.6666*((itfi*(-itfi*ick_Vci_ei/ick/ick))/iqfe_t)*d10_logE0)*d10_exp1;
qmE_Vbi_ci=(0.6666*((itfi*(-itfi*ick_Vbi_ci/ick/ick))/iqfe_t)*d10_logE0)*d10_exp1;
qmE_Vb_ci=(0.6666*((itfi*(-itfi*ick_Vb_ci/ick/ick))/iqfe_t)*d10_logE0)*d10_exp1;
#endif
qmE=d00_exp1;
}
}
...
#if defined(_DERIVATE)
qm0_Vtnode_GND=(((itfi_Vtnode_GND*ickf-itfi*ickf_Vtnode_GND)/ickf/ickf)+((itri_Vtnode_GND*ickr-itri*ickr_Vtnode_GND)/ickr/ickr));
qm0_Vbi_ei=(itfi_Vbi_ei/ickf);
qm0_Vbi_ci=((-itfi*ickf_Vbi_ci/ickf/ickf)+(itri_Vbi_ci/ickr));
qm0_Vb_ci=(-itfi*ickf_Vb_ci/ickf/ickf);
#endif
qm0=((itfi/ickf)+(itri/ickr));
#if defined(_DERIVATE)
qmB_Vtnode_GND=((itfi_Vtnode_GND*iqfh_t-itfi*iqfh_t_Vtnode_GND)/iqfh_t/iqfh_t);
qmB_Vbi_ei=(itfi_Vbi_ei/iqfh_t);
#endif
qmB=(itfi/iqfh_t);
#if defined(_DERIVATE)
qml_Vtnode_GND=(qm0_Vtnode_GND+qmE_Vtnode_GND);
qml_Vbi_ei=(qm0_Vbi_ei+qmE_Vbi_ei);
qml_Vbi_ci=(qm0_Vbi_ci+qmE_Vbi_ci);
qml_Vb_ci=(qm0_Vb_ci+qmE_Vb_ci);
qml_Vci_ei=qmE_Vci_ei;
#endif
qml=(qm0+qmE);
#if defined(_DERIVATE)
qmh_Vtnode_GND=(qml_Vtnode_GND+qmB_Vtnode_GND);
qmh_Vbi_ei=(qml_Vbi_ei+qmB_Vbi_ei);
qmh_Vbi_ci=qml_Vbi_ci;
qmh_Vb_ci=qml_Vb_ci;
qmh_Vci_ei=qml_Vci_ei;
#endif
qmh=(qml+qmB);
{
...
qpt_l_Vci_ei=qml_Vci_ei*d10_sqrt0;
#endif
...
qpt_h_Vci_ei=qmh_Vci_ei*d10_sqrt0;
#endif
...
a1_Vbi_ei=(-(((((ick_Vbi_ei/(1+ahq))*itfi-(ick/(1+ahq))*itfi_Vbi_ei)/itfi/itfi)*qpt_l)+(((ick/(1+ahq))/itfi)*qpt_l_Vbi_ei)));
a1_Vbi_ci=(-((((ick_Vbi_ci/(1+ahq))/itfi)*qpt_l)+(((ick/(1+ahq))/itfi)*qpt_l_Vbi_ci)));
a1_Vb_ci=(-((((ick_Vb_ci/(1+ahq))/itfi)*qpt_l)+(((ick/(1+ahq))/itfi)*qpt_l_Vb_ci)));
#endif
...
a2_Vbi_ei=(((((ick_Vbi_ei/(1+ahq))*itfi-(ick/(1+ahq))*itfi_Vbi_ei)/itfi/itfi)*(qpt_h-qpt_l))+(((ick/(1+ahq))/itfi)*(qpt_h_Vbi_ei-qpt_l_Vbi_ei)));
a2_Vbi_ci=((((ick_Vbi_ci/(1+ahq))/itfi)*(qpt_h-qpt_l))+(((ick/(1+ahq))/itfi)*(qpt_h_Vbi_ci-qpt_l_Vbi_ci)));
a2_Vb_ci=((((ick_Vb_ci/(1+ahq))/itfi)*(qpt_h-qpt_l))+(((ick/(1+ahq))/itfi)*(qpt_h_Vb_ci-qpt_l_Vb_ci)));
#endif
...
#if defined(_DERIVATE)
qmBw_Vtnode_GND=((((qmB_Vtnode_GND*w)+(qmB*w_Vtnode_GND))*w)+((qmB*w)*w_Vtnode_GND));
qmBw_Vbi_ei=((((qmB_Vbi_ei*w)+(qmB*w_Vbi_ei))*w)+((qmB*w)*w_Vbi_ei));
qmBw_Vci_ei=(((qmB*w_Vci_ei)*w)+((qmB*w)*w_Vci_ei));
qmBw_Vbi_ci=(((qmB*w_Vbi_ci)*w)+((qmB*w)*w_Vbi_ci));
qmBw_Vb_ci=(((qmB*w_Vb_ci)*w)+((qmB*w)*w_Vb_ci));
#endif
qmBw=((qmB*w)*w);
#if defined(_DERIVATE)
qm_Vtnode_GND=(qml_Vtnode_GND+qmBw_Vtnode_GND);
qm_Vbi_ei=(qml_Vbi_ei+qmBw_Vbi_ei);
qm_Vbi_ci=(qml_Vbi_ci+qmBw_Vbi_ci);
qm_Vb_ci=(qml_Vb_ci+qmBw_Vb_ci);
qm_Vci_ei=(qml_Vci_ei+qmBw_Vci_ei);
#endif
qm=(qml+qmBw);
{
...
qpt_Vci_ei=qm_Vci_ei*d10_sqrt0;
#endif
qpt=(qj_2+d00_sqrt0);
}
#if defined(_DERIVATE)
...
a_Vbi_ei=(-((ick_Vbi_ei*itf-ick*itf_Vbi_ei)/itf/itf));
a_Vbi_ci=(-((ick_Vbi_ci*itf-ick*itf_Vbi_ci)/itf/itf));
a_Vb_ci=(-((ick_Vb_ci*itf-ick*itf_Vb_ci)/itf/itf));
...
dtef_Vbi_ei=(tef0_t*(gte*((itf_Vbi_ei*ick-itf*ick_Vbi_ei)/ick/ick)*d10_logE0)*d10_exp1);
dtef_Vbi_ci=(tef0_t*(gte*((itf_Vbi_ci*ick-itf*ick_Vbi_ci)/ick/ick)*d10_logE0)*d10_exp1);
dtef_Vb_ci=(tef0_t*(gte*((itf_Vb_ci*ick-itf*ick_Vb_ci)/ick/ick)*d10_logE0)*d10_exp1);
...
#endif
#if defined(_DERIVATE)
ibrec_Vtnode_GND=(ibhrec*qmBw_Vtnode_GND);
ibrec_Vbi_ei=(ibhrec*qmBw_Vbi_ei);
ibrec_Vci_ei=(ibhrec*qmBw_Vci_ei);
ibrec_Vbi_ci=(ibhrec*qmBw_Vbi_ci);
ibrec_Vb_ci=(ibhrec*qmBw_Vb_ci);
#endif
ibrec=(ibhrec*qmBw);
#if defined(_DERIVATE)
DIOY_Vs_ci=0.0;
...
#if defined(_DERIVATE)
ijbe_Vtnode_GND=((ibe_Vtnode_GND+ire_Vtnode_GND)+ibrec_Vtnode_GND);
ijbe_Vbi_ei=((ibe_Vbi_ei+ire_Vbi_ei)+ibrec_Vbi_ei);
ijbe_Vci_ei=ibrec_Vci_ei;
ijbe_Vbi_ci=ibrec_Vbi_ci;
ijbe_Vb_ci=ibrec_Vb_ci;
#endif
ijbe=((ibe+ire)+ibrec);
#if defined(_DERIVATE)
DIOY_Vs_ci=0.0;
...
ibi_Vci_ei=ijbe_Vci_ei;
ibi_Vbi_ci=(ijbe_Vbi_ci+ijbc_Vbi_ci);
ibi_Vb_ci=ijbe_Vb_ci;
#endif
ibi=(ijbe+ijbc);
if
((Vbici<0))
...
y_Vbi_ei=(-((x_Vbi_ei*d00_logE0)+(x*(-(v_j_Vbi_ei/vde_t))*d10_logE0))*d10_exp1);
y_Vbi_ci=(-((x_Vbi_ci*d00_logE0)+(x*(-(v_j_Vbi_ci/vde_t))*d10_logE0))*d10_exp1);
y_Vtnode_GND=(-((x_Vtnode_GND*d00_logE0)+(x*(-((v_j_Vtnode_GND*vde_t-v_j*vde_t_Vtnode_GND)/vde_t/vde_t))*d10_logE0))*d10_exp1);
y_Vb_ci=(-((x_Vb_ci*d00_logE0)+(x*(-(v_j_Vb_ci/vde_t))*d10_logE0))*d10_exp1);
#endif
y=(1.0-d00_exp1);
}
#if defined(_DERIVATE)
...
qjei_Vbi_ei=(((((cje0_t*vde_t)*y_Vbi_ei)*x-((cje0_t*vde_t)*y)*x_Vbi_ei)/x/x)+((aje_t*cje0_t)*(Vbiei_Vbi_ei-v_j_Vbi_ei)));
qjei_Vbi_ci=(((((cje0_t*vde_t)*y_Vbi_ci)*x-((cje0_t*vde_t)*y)*x_Vbi_ci)/x/x)+((aje_t*cje0_t)*(-v_j_Vbi_ci)));
qjei_Vb_ci=(((((cje0_t*vde_t)*y_Vb_ci)*x-((cje0_t*vde_t)*y)*x_Vb_ci)/x/x)+((aje_t*cje0_t)*(-v_j_Vb_ci)));
#endif
...
{
#if defined(_DERIVATE)
Qz_nom_Vtnode_GND=(((qje_Vtnode_GND/vr0e)+(qjci_Vtnode_GND/vr0c))+qm0_Vtnode_GND);
Qz_nom_Vci_ei=(qje_Vci_ei/vr0e);
Qz_nom_Vbi_ei=((qje_Vbi_ei/vr0e)+qm0_Vbi_ei);
Qz_nom_Vbi_ci=(((qje_Vbi_ci/vr0e)+(qjci_Vbi_ci/vr0c))+qm0_Vbi_ci);
Qz_nom_Vb_ci=(((qje_Vb_ci/vr0e)+(qjci_Vb_ci/vr0c))+qm0_Vb_ci);
#endif
...
y_Vci_ei=(-x_Vci_ei*d00_logE0*d10_exp1);
y_Vbi_ei=(-((x_Vbi_ei*d00_logE0)+(x*(-(v_j_Vbi_ei/vds_t))*d10_logE0))*d10_exp1);
y_Vbi_ci=(-((x_Vbi_ci*d00_logE0)+(x*(-(v_j_Vbi_ci/vds_t))*d10_logE0))*d10_exp1);
y_Vtnode_GND=(-((x_Vtnode_GND*d00_logE0)+(x*(-((v_j_Vtnode_GND*vds_t-v_j*vds_t_Vtnode_GND)/vds_t/vds_t))*d10_logE0))*d10_exp1);
y_Vb_ci=(-((x_Vb_ci*d00_logE0)+(x*(-(v_j_Vb_ci/vds_t))*d10_logE0))*d10_exp1);
#endif
y=(1.0-d00_exp1);
}
#endif
...
qjs_Vbi_ei=(((((cjs0_t*vds_t)*y_Vbi_ei)*x-((cjs0_t*vds_t)*y)*x_Vbi_ei)/x/x)+((2.4*cjs0_t)*(-v_j_Vbi_ei)));
qjs_Vs_ci=((((cjs0_t*vds_t)*y_Vs_ci)/x)+((2.4*cjs0_t)*(Vsci_Vs_ci-v_j_Vs_ci)));
qjs_Vbi_ci=(((((cjs0_t*vds_t)*y_Vbi_ci)*x-((cjs0_t*vds_t)*y)*x_Vbi_ci)/x/x)+((2.4*cjs0_t)*(-v_j_Vbi_ci)));
...
qjs_Vb_ci=(((((cjs0_t*vds_t)*y_Vb_ci)*x-((cjs0_t*vds_t)*y)*x_Vb_ci)/x/x)+((2.4*cjs0_t)*(-v_j_Vb_ci)));
#endif
...
pterm_Vbi_ci=(((((Vciei*it_Vbi_ci)+(((-Vbici_Vbi_ci)*iavl)+((vdci_t-Vbici)*iavl_Vbi_ci)))+ijbe_Vbi_ci*Vbiei)+((ijbc_Vbi_ci*Vbici)+(ijbc*Vbici_Vbi_ci)))+ijsc_Vbi_ci*Vsci);
pterm_Vb_ci=(((Vciei*it_Vb_ci)+((vdci_t-Vbici)*iavl_Vb_ci))+ijbe_Vb_ci*Vbiei);
pterm_Vci_ei=((((Vciei_Vci_ei*it)+(Vciei*it_Vci_ei))+((vdci_t-Vbici)*iavl_Vci_ei))+ijbe_Vci_ei*Vbiei);
#endif
...
ijbe_Vci_ei=(HICUMtype*ijbe_Vci_ei);
ijbe_Vbi_ci=(HICUMtype*ijbe_Vbi_ci);
ijbe_Vb_ci=(HICUMtype*ijbe_Vb_ci);
#endif
ijbe=(HICUMtype*ijbe);
#if defined(_DYNAMIC)
#if defined(_DERIVATE)
...
#if defined(_DERIVATE)
_load_static_jacobian4(bi,ei,b,ci,ijbe_Vb_ci);
_load_static_jacobian4(bi,ei,bi,ci,ijbe_Vbi_ci);
_load_static_jacobian4(bi,ei,ci,ei,ijbe_Vci_ei);
...
flicker_Pwr_Vci_ei=(kf*(d10_pow0*ijbe_Vci_ei));
flicker_Pwr_Vbi_ci=(kf*(d10_pow0*ijbe_Vbi_ci));
flicker_Pwr_Vb_ci=(kf*(d10_pow0*ijbe_Vb_ci));
#endif
...
void hicumL0V1p2g::saveOperatingPoints (void)
{
...
void hicumL0V1p2g::loadOperatingPoints (void)
{
}

/* Calculate operating points. */
void hicumL0V1p2g::calcOperatingPoints (void)
{
}

/* Initialization of AC analysis. */
void hicumL0V1p2g::initAC (void)
{
  allocMatrixMNA ();
}

/* Perform AC calculations. */
void hicumL0V1p2g::calcAC (nr_double_t frequency)
{
  setMatrixY (calcMatrixY (frequency));
}

/* Compute Y-matrix for AC analysis. */
matrix hicumL0V1p2g::calcMatrixY (nr_double_t frequency)
{
  _freq = frequency;
  saveOperatingPoints ();
  matrix y (8);
...
void hicumL0V1p2g::initSP (void)
{
  allocMatrixS ();
}

/* Perform S-parameter calculations. */
void hicumL0V1p2g::calcSP (nr_double_t frequency)
{
  setMatrixS (ytos (calcMatrixY (frequency)));   
}

/* Initialization of transient analysis. */
void hicumL0V1p2g::initTR (void)
{
  setStates (2 * 8 * 8);
  initDC ();
}
...
void hicumL0V1p2g::calcTR (nr_double_t)
{
  doHB = 0;
  doAC = 1;
  doTR = 1;
...
matrix hicumL0V1p2g::calcMatrixCy (nr_double_t frequency) 
{
  _freq = frequency;
  matrix cy (8);
