/*
 * hicumL0V1p2g.core.h - device class definitions for hicumL0V1p2g module
 *
...
#ifndef __hicumL0V1p2g_H__
#define __hicumL0V1p2g_H__

class hicumL0V1p2g : public qucs::circuit
{
 public:
  CREATOR (hicumL0V1p2g);
