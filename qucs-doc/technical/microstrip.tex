...
\begin{itemize}
\item In equation \ref{eqn:mscross_cx} and \label{eqn:mscross_c1} for $W_2$
      only, whereas $W_1$ is replaced by the width of the line.
\item In equation \ref{eqn:mscross_ly} and \label{eqn:mscross_l1} for $W_2$
      only, whereas $W_1$ is replaced by the width of the line.
\item In equation \label{eqn:mscross_l3} for $W_1$ and $W_2$.
\end{itemize}
