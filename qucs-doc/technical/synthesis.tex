...
\begin{alignat}{3}
 ...
 & \text{with}         \qquad & X_k = & \dfrac{2}{\omega_B} \cdot \sin \dfrac{(2\cdot k + 1)\pi}{2\cdot n}
\end{alignat}
...
\begin{alignat}{3}
 ...
 & & a_k & = \sin \dfrac{(2\cdot k + 1)\pi}{2\cdot n} \\
 & & g_k & =
\begin{cases}
  \dfrac{a_k}{r} & \text{for} \quad k=0\\
  \dfrac{a_{k-1}\cdot a_k}{g_{k-1}\cdot \left( r^2 + \sin^2\dfrac{k\cdot\pi}{n} \right)}
                 & \text{for} \quad k\ge 1
\end{cases} \\
