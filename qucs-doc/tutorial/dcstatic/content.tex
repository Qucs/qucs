...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.75\linewidth]{highpassrc}
...
Finally by pressing F2 the simulation takes places and a graphic
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.75\linewidth]{finalhighpassrc}
