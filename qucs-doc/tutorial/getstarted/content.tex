...
\textbf{Beta\_vs\_Ic}.  The appropiate base current shown in the
...
relationship betwenn AC analysis and the S-parameter simulation.  In
the next section we are going to explain this releationship using a
...
fig.~\ref{fig:bpsp_2}.  In the logarthmic cartesian diagram the
