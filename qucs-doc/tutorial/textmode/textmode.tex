...
\subsubsection{Analysis with Octave}
...
\subsubsection{Analysis with Python}
...
\begin{figure}[h]
\begin{center}
  \includegraphics[angle=0,width=0.8\linewidth]{rc_ac_python.eps}
  \caption{Simulation Result}
...
\begin{figure}[h]
\begin{center}
  \includegraphics[angle=0,width=0.8\linewidth]{rc_ac_sweep_python.eps}
  \caption{Simulation Result}
  \label{plot:rc_ac_python}
\end{center}
\end{figure}
