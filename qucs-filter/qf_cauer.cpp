...
void
  qf_cauer::normalize	(double amin, double amax, 
			 double fs, qft type)
  ...
  main (void)
{
  ...
  while (true)
  {
    ...
    std::cout << "Enter stopband frequence (Hz): " ;
    std::cin >> fs ;
