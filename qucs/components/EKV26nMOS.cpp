/*
 * EKV26nMOS.cpp - device implementations for EKV26nMOS module
 *
...
EKV26nMOS::EKV26nMOS()
{
  Description = QObject::tr ("EPFL-EKV NMOS 2.6 verilog device");
...
Component * EKV26nMOS::newOne()
{
  EKV26nMOS * p = new EKV26nMOS();
  p->Props.getFirst()->Value = Props.getFirst()->Value; 
  p->recreate(0); 
  return p;
}

Element * EKV26nMOS::info(QString& Name, char * &BitmapFile, bool getNewOne)
{
  Name = QObject::tr("EPFL-EKV NMOS 2.6");
  BitmapFile = (char *) "EKV26nMOS";

  if(getNewOne) return new EKV26nMOS();
  return 0;
}

void EKV26nMOS::createSymbol()
{
