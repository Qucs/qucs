...
static const char *List_rho[] = {"rho",
...
static const char *List_tand[] = {"tand",
...
static const char **List_Properties[] =
  {(const char**)&List_er, (const char**)&List_tand, (const char**)&List_rho, 0};
