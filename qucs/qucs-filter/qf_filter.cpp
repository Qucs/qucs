...
// Just initialize a few things
  ...
  qf_filter::qf_filter (int n) :
			type (LOWPASS), kind (UNDEF), o (n), f (0), bw (0),
			imp (1), ncomp (0), Comp (NULL)
...
// Default constructor
  ...
  qf_filter::qf_filter () :
			  type (LOWPASS), kind (UNDEF), o (0), f (0), bw (0),
			  imp (1), ncomp (0), Comp (NULL)
...
void
  qf_filter::extract_pole_pCsLC (double p, qfc * pComp, double Ws)
