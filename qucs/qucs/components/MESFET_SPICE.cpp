...
{
    Description = QObject::tr("MESFET SPICE format");
...
Lines.append(new Line(-10,-15,-10, 15,QPen(Qt::red,3)));
  ...
  Lines.append(new Line(  0,-10,  0,-30,QPen(Qt::red,3)));
  Lines.append(new Line(-10, 10,  0, 10,QPen(Qt::red,3)));
  Lines.append(new Line(  0, 10,  0, 30,QPen(Qt::red,3)));

  Lines.append(new Line( -4, 24,  4, 20,QPen(Qt::red,3)));
