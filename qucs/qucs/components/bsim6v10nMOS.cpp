/*
 * bsim6v10nMOS.cpp - device implementations for bsim6v10nMOS module
 *
...
bsim6v10nMOS::bsim6v10nMOS()
{
  Description = QObject::tr ("bsim6v10nMOS verilog device");
  ...
  Props.append (new Property ("AIGC", "1.36e-2", false,
    QObject::tr ("Parameter for Igc")));
  Props.append (new Property ("BIGC", "1.71e-3", false,
    QObject::tr ("Parameter for Igc")));
  Props.append (new Property ("CIGC", "0.075", false,
    QObject::tr ("Parameter for Igc")));
  Props.append (new Property ("AIGS", "1.36e-2", false,
    QObject::tr ("Parameter for Igs d")));
  Props.append (new Property ("BIGS", "1.71e-3", false,
    QObject::tr ("Parameter for Igs d")));
  Props.append (new Property ("CIGS", "0.075", false,
    QObject::tr ("Parameter for Igs d")));
  Props.append (new Property ("AIGD", "1.36e-2", false,
    QObject::tr ("Parameter for Igs d")));
  Props.append (new Property ("BIGD", "1.71e-3", false,
    QObject::tr ("Parameter for Igs d")));
  Props.append (new Property ("CIGD", "0.075", false,
    QObject::tr ("Parameter for Igs d")));
...
Component * bsim6v10nMOS::newOne()
{
  bsim6v10nMOS * p = new bsim6v10nMOS();
  p->Props.getFirst()->Value = Props.getFirst()->Value; 
  p->recreate(0); 
  return p;
}

Element * bsim6v10nMOS::info(QString& Name, char * &BitmapFile, bool getNewOne)
{
  Name = QObject::tr("bsim6v10nMOS");
  BitmapFile = (char *) "bsim6v10nMOS";

  if(getNewOne) return new bsim6v10nMOS();
  return 0;
}

void bsim6v10nMOS::createSymbol()
{
