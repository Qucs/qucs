/*
 * hic0p2_full.cpp - device implementations for hic0p2_full module
 *
...
Component * hic0p2_full::newOne()
{
  hic0p2_full * p = new hic0p2_full();
  p->Props.getFirst()->Value = Props.getFirst()->Value; 
  p->recreate(0); 
  return p;
}

Element * hic0p2_full::info(QString& Name, char * &BitmapFile, bool getNewOne)
{
  Name = QObject::tr("npn HICUM L0 v1.2");
  BitmapFile = (char *) "npnsub_therm";

  if(getNewOne) return new hic0p2_full();
  return 0;
}

Element * hic0p2_full::info_pnp(QString& Name, char * &BitmapFile, bool getNewOne)
{
...
QString hic0p2_full::netlist()
{
  QString s = "hic0p2_full:"+Name;
