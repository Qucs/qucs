...
// -------------------------------------------------------
GraphicItem* MOSFET_sub::info(QString& Name, char* &BitmapFile, bool getNewOne)
{
...
// -------------------------------------------------------
GraphicItem* MOSFET_sub::info_p(QString& Name,
...
// -------------------------------------------------------
GraphicItem* MOSFET_sub::info_depl(QString& Name,
			char* &BitmapFile, bool getNewOne)
{
