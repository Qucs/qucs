...
// ------------------------------------------------------------
void TimingDiagram::paint(QPainter *painter, const QStyleOptionGraphicsItem *item, QWidget *widget)
{
...
// ------------------------------------------------------------
GraphicItem* TimingDiagram::info(QString& Name, char* &BitmapFile, bool getNewOne)
{
