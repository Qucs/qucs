...
/*!
  \class waveac
  \temperal representation of voltage and current in AC
*/
/***************************************************************************
                                waveac.cpp
                               -----------
...
void Waveac::calcData(Graph *g)
{
  ...
  sc = int(xAxis.up*freq[0])+1;//will determine how many point need to be created
  ...
  for(j=g->countY; j>0; j--) {  // every branch of curves
    ...
    m++;
    yp = g->gy;
    //with the points will calculate the Amplitude and phase of the sine wave
    af = atan2 (yp[1],yp[0]);
