...
struct ImplementationParams {
    ...
    int use_l4_lumped_equivalent = 0, use_l8_lumped_equivalent = 0, use_TL_lumped_equivalent = 0;
...
private:
  QLabel *Order_Label, *Network_Response_Label, *QualityFactor_Label, *maxRipple_Label, *Weighting_Type_Label,
         ...
         *k_Transformer_Label, *coupled_L_Label, *BW_Label, *f2_Label, *Lumped_QW_Label, *Lumped_L8_Label, *Lumped_TL_Label;
  QComboBox *Network_Response_Combo, *Stub_Type_Combo, *Weighting_Type_Combo, *Stub_Implementation_Combo, *L2_Double_Tapped_Resonator_Scale_Combo,
            *coupled_L_Combo, *BW_Scale_Combo, *f2_Scale_Combo, *Lumped_QW_Combo, *Lumped_L8_Combo, *Lumped_TL_Combo;
