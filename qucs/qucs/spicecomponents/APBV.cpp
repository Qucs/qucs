...
APBV::APBV()
{
  Description = QObject::tr("XSPICE two input voltage adder block:\nTwo line XSPICE specification. ");
...
Component* APBV::newOne()
{
  return new APBV();
}

Element* APBV::info(QString& Name, char* &BitmapFile, bool getNewOne)
{
  Name = QObject::tr("ADD");
  BitmapFile = (char *) "APBV"; 

  if(getNewOne)  return new APBV();
  return 0;
}

QString APBV::netlist()
{
    return QString("");
}

QString APBV::spice_netlist(bool)
{
