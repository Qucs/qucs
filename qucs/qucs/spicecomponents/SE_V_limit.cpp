...
SE_V_limit::SE_V_limit()
{
  Description = QObject::tr("XSPICE A_limit_SE block:\nTwo line XSPICE specification. ");
...
Component* SE_V_limit::newOne()
{
  return new SE_V_limit();
}

Element* SE_V_limit::info(QString& Name, char* &BitmapFile, bool getNewOne)
{
  Name = QObject::tr("A_limit_SE");
  BitmapFile = (char *) "SE_V_limit"; 

  if(getNewOne)  return new SE_V_limit();
  return 0;
}

QString SE_V_limit::netlist()
{
    return QString("");
}

QString SE_V_limit::spice_netlist(bool)
{
