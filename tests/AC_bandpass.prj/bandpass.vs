...
Sub #(.$xposition(340), .$yposition(180), .$ty(-20), .$tx(44), .File(opa227.sch)) OPA227_1(net_310_210, net_310_150, net_370_180);
Sub #(.$xposition(620), .$yposition(180), .$ty(-20), .$tx(44), .File(opa227.sch)) OPA227_2(net_590_210, net_590_150, net_650_180);
//AC1
