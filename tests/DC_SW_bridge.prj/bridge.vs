(* qucs_ViewX1=0, qucs_ViewY1=0, qucs_ViewX2=800, qucs_ViewY2=800, qucs_Scale=1, qucs_tmpViewX1=0, qucs_tmpViewY1=0, qucs_GridX=10, qucs_GridY=10, qucs_GridOn=1, qucs_DataSet="bridge.dat", qucs_DataDisplay="bridge.dpl", qucs_SimOpenDpl=1, qucs_Script="bridge.m", qucs_SimRunScript=0, qucs_showFrame=0, qucs_FrameText0="Title", qucs_FrameText1="Drawn By:", qucs_FrameText2="Date:", qucs_FrameText3="Revision:" *) module bridge();
    ...
    wire n_460_200;
    wire n_180_100;
    (* qucs_mirrored=0, qucs_rotated=0, qucs_visible="", S0_x1=310, S0_y1=200, S0_x2=370, S0_y2=200 *) IProbe #() Pr1 ( n_310_200, n_370_200 );
    (* qucs_mirrored=0, qucs_rotated=1, qucs_visible="100000", S0_x1=460, S0_y1=160, S0_x2=460, S0_y2=100 *) R #(.R(500 Ohm),.Temp(26.85),.Tc1(0.0),.Tc2(0.0),.Tnom(26.85)) R2 ( n_460_160, n_460_100 );
    (* qucs_mirrored=0, qucs_rotated=1, qucs_visible="1", S0_x1=180, S0_y1=170, S0_x2=180, S0_y2=230 *) Vdc #(.U(1 V)) V1 ( n_180_170, n_180_230 );
    (* qucs_mirrored=0, qucs_rotated=0, qucs_visible="", S0_x1=280, S0_y1=300 *) GND #() \*  ( n_280_300 );
    (* qucs_mirrored=0, qucs_rotated=0, qucs_visible="", S0_x1=460, S0_y1=300 *) GND #() \*  ( n_460_300 );
    (* qucs_mirrored=0, qucs_rotated=1, qucs_visible="100000", S0_x1=460, S0_y1=300, S0_x2=460, S0_y2=240 *) R #(.R(Rmeasure),.Temp(26.85),.Tc1(0.0),.Tc2(0.0),.Tnom(26.85)) R5 ( n_460_300, n_460_240 );
    ...
    (* qucs_mirrored=0, qucs_rotated=0, qucs_visible="111111", S0_x1=300, S0_y1=370 *) \.SW  #(.Sim(DC1),.Type(lin),.Start(Rmeasure),.Stop(10 Ohm),.Points(1 kOhm),.Points(100)) SW1 (  );
    (* qucs_mirrored=0, qucs_rotated=0, qucs_visible="111111", S0_x1=410, S0_y1=370 *) \.SW  #(.Sim(SW1),.Type(lin),.Start(Rbranch),.Stop(200 Ohm),.Points(1 kOhm),.Points(4)) SW2 (  );
    (* qucs_mirrored=0, qucs_rotated=0, qucs_visible="10", S0_x1=500, S0_y1=360 *) Eqn #(.Umeasure(500 * abs(Pr1.I)),.Export(yes)) Eqn1 (  );
