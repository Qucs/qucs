(* qucs_ViewX1=0, qucs_ViewY1=0, qucs_ViewX2=800, qucs_ViewY2=800, qucs_Scale=1, qucs_tmpViewX1=0, qucs_tmpViewY1=0, qucs_GridX=10, qucs_GridY=10, qucs_GridOn=1, qucs_DataSet="resonance.dat", qucs_DataDisplay="resonance.dpl", qucs_SimOpenDpl=1, qucs_Script="resonance.m", qucs_SimRunScript=0, qucs_showFrame=0, qucs_FrameText0="Title", qucs_FrameText1="Drawn By:", qucs_FrameText2="Date:", qucs_FrameText3="Revision:" *) module resonance();
    ...
    wire n_440_70;
    wire n_440_200;
    (* S0_x1=120, S0_y1=120, S0_x2=120, S0_y2=180, qucs_mirrored=0, qucs_rotated=1 *) Vac #(.U(1 V),.f(1 GHz),.Phase(0),.Theta(0)) V1 ( n_120_120, n_120_180 );
    (* S0_x1=320, S0_y1=240, qucs_mirrored=0, qucs_rotated=0 *) GND #() \*  ( n_320_240 );
    (* S0_x1=120, S0_y1=240, qucs_mirrored=0, qucs_rotated=0 *) GND #() \*  ( n_120_240 );
    (* S0_x1=320, S0_y1=120, S0_x2=320, S0_y2=60, qucs_mirrored=0, qucs_rotated=1 *) R #(.R(R_par),.Temp(26.85),.Tc1(0.0),.Tc2(0.0),.Tnom(26.85)) R1 ( n_320_120, n_320_60 );
    (* S0_x1=320, S0_y1=240, S0_x2=320, S0_y2=180, qucs_mirrored=0, qucs_rotated=1 *) C #(.C(2 pF),.V(),.Symbol(neutral)) C1 ( n_320_240, n_320_180 );
    (* S0_x1=320, S0_y1=180, S0_x2=320, S0_y2=120, qucs_mirrored=0, qucs_rotated=1 *) L #(.L(13 nH),.I()) L1 ( n_320_180, n_320_120 );
