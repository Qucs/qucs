...
//AC1
wire #(.$vscale(60), .$xposition(120), .$yposition(180), .$vflip(1), .$hflip(1), .$angle(270)) noname(net_120_180, net_120_240);
wire #(.$vscale(200), .$xposition(120), .$yposition(60), .$vflip(1), .$hflip(1), .$angle(0)) noname(net_120_60, net_320_60);
wire #(.$vscale(60), .$xposition(120), .$yposition(60), .$vflip(1), .$hflip(1), .$angle(270)) noname(net_120_60, net_120_120);
wire #(.$tx(-80), .$ty(-40), .netname(Voltage), .$vscale(0), .$xposition(320), .$yposition(180), .$vflip(1), .$hflip(1), .$angle(0)) noname(net_320_180, net_320_180);
