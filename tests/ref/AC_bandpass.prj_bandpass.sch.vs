...
Sub #(.$tx(-20), .$ty(44), .File(opa227.sch), .$xposition(340), .$yposition(180), .$vflip(1), .$hflip(1)) OPA227_1(net_310_210, net_310_150, net_370_180);
Sub #(.$tx(-20), .$ty(44), .File(opa227.sch), .$xposition(620), .$yposition(180), .$vflip(1), .$hflip(1)) OPA227_2(net_590_210, net_590_150, net_650_180);
//AC1
...
Eqn #(.y1(dB(Vout.v)), .y2(phase(Vout.v)), .Export(yes), .$ty(-25), .$tx(-25), .$xposition(460), .$yposition(380), .$vflip(1), .$hflip(1)) Eqn1();
...
wire #(.$tx(50), .$ty(-30), .netname(Vout), .$xposition(700), .$yposition(180), .$vflip(1), .$hflip(1)) noname(net_700_180, net_730_180);
...
wire #(.$tx(20), .$ty(-30), .netname(Vin), .$xposition(100), .$yposition(210), .$vflip(1), .$hflip(1)) noname(net_100_210, net_180_210);
