(* qucs_ViewX1=0, qucs_ViewY1=-180, qucs_ViewX2=1524, qucs_ViewY2=908, qucs_Scale=0.909091, qucs_tmpViewX1=0, qucs_tmpViewY1=57, qucs_GridX=10, qucs_GridY=10, qucs_GridOn=1, qucs_DataSet="wattmeter.dat", qucs_DataDisplay="wattmeter.dpl", qucs_SimOpenDpl=0, qucs_Script="wattmeter.m", qucs_SimRunScript=0, qucs_showFrame=0, qucs_FrameText0="Title", qucs_FrameText1="Drawn By:", qucs_FrameText2="Date:", qucs_FrameText3="Revision:" *) module wattmeter();
    ...
    wire n_56_217;
    wire n_226_437;
    (* qucs_mirrored=0, qucs_rotated=1, qucs_visible="1000", S0_x1=56, S0_y1=247, S0_x2=56, S0_y2=307 *) Vac #(.U(150 V),.f(1 GHz),.Phase(0),.Theta(0)) V1 ( n_56_247, n_56_307 );
    (* qucs_mirrored=0, qucs_rotated=0, qucs_visible="", S0_x1=56, S0_y1=437 *) GND #() \*  ( n_56_437 );
    (* qucs_mirrored=0, qucs_rotated=1, qucs_visible="100000", S0_x1=306, S0_y1=287, S0_x2=306, S0_y2=227 *) R #(.R(15 Ohm),.Temp(26.85),.Tc1(0.0),.Tc2(0.0),.Tnom(26.85)) R1 ( n_306_287, n_306_227 );
    (* qucs_mirrored=0, qucs_rotated=1, qucs_visible="100000", S0_x1=406, S0_y1=287, S0_x2=406, S0_y2=227 *) R #(.R(6 Ohm),.Temp(26.85),.Tc1(0.0),.Tc2(0.0),.Tnom(26.85)) R2 ( n_406_287, n_406_227 );
