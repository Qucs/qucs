// VS::printSubckt main
module main();
OpAmp #(.G(1e6), .Umax(15 V), .$ty(-26), .$tx(-26), .$xposition(370), .$yposition(160), .$vflip(1), .$hflip(1)) OP1(net_340_180, net_340_140, net_410_160);
GND #(.$xposition(300), .$yposition(180), .$vflip(1), .$hflip(1)) anonymous_gnd_hack_0(net_300_180);
GND #(.$xposition(180), .$yposition(260), .$vflip(1), .$hflip(1)) anonymous_gnd_hack_1(net_180_260);
GND #(.$xposition(60), .$yposition(260), .$vflip(1), .$hflip(1)) anonymous_gnd_hack_2(net_60_260);
Vac #(.U(1 V), .f(1 GHz), .Phase(0), .Theta(0), .$ty(18), .$tx(18), .$xposition(60), .$yposition(230), .$vflip(1), .$hflip(1)) V1(net_60_200, net_60_260);
R #(.R(390), .Temp(26.85), .Tc1(0.0), .Tc2(0.0), .Tnom(26.85), .Symbol(european), .$ty(-26), .$tx(-26), .$xposition(130), .$yposition(140), .$vflip(1), .$hflip(1)) R3(net_100_140, net_160_140);
R #(.R(5.6k), .Temp(26.85), .Tc1(0.0), .Tc2(0.0), .Tnom(26.85), .Symbol(european), .$ty(15), .$tx(15), .$xposition(180), .$yposition(230), .$vflip(1), .$hflip(1)) R2(net_180_260, net_180_200);
C #(.C(47n), .V(), .Symbol(neutral), .$ty(-26), .$tx(-26), .$xposition(230), .$yposition(140), .$vflip(1), .$hflip(1)) C1(net_200_140, net_260_140);
C #(.C(47n), .V(), .Symbol(neutral), .$ty(17), .$tx(17), .$xposition(180), .$yposition(90), .$vflip(1), .$hflip(1)) C2(net_180_120, net_180_60);
R #(.R(3.9k), .Temp(26.85), .Tc1(0.0), .Tc2(0.0), .Tnom(26.85), .Symbol(european), .$ty(15), .$tx(15), .$xposition(300), .$yposition(90), .$vflip(1), .$hflip(1)) R1(net_300_120, net_300_60);
//AC1
//DC1
...
wire #(.$tx(40), .$ty(0), .netname(Output), .$xposition(410), .$yposition(50), .$vflip(1), .$hflip(1)) noname(net_410_50, net_410_160);
