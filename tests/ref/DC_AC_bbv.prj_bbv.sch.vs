(* qucs_ViewX1=-104, qucs_ViewY1=0, qucs_ViewX2=733, qucs_ViewY2=593, qucs_Scale=0.924731, qucs_tmpViewX1=0, qucs_tmpViewY1=0, qucs_GridX=10, qucs_GridY=10, qucs_GridOn=1, qucs_DataSet="bbv.dat", qucs_DataDisplay="bbv.dpl", qucs_SimOpenDpl=1, qucs_Script="bbv.m", qucs_SimRunScript=0, qucs_showFrame=0, qucs_FrameText0="Title", qucs_FrameText1="Drawn By:", qucs_FrameText2="Date:", qucs_FrameText3="Revision:" *) module bbv();
    ...
    wire n_650_220;
    wire n_650_250;
    (* S0_x1=130, S0_y1=370, S0_x2=130, S0_y2=310, qucs_mirrored=0, qucs_rotated=1 *) R #(.R(12),.Temp(26.85),.Tc1(0.0),.Tc2(0.0),.Tnom(26.85)) RE1 ( n_130_370, n_130_310 );
    (* S0_x1=130, S0_y1=150, S0_x2=130, S0_y2=90, qucs_mirrored=0, qucs_rotated=1 *) R #(.R(650),.Temp(26.85),.Tc1(0.0),.Tc2(0.0),.Tnom(26.85)) R1 ( n_130_150, n_130_90 );
    (* S0_x1=100, S0_y1=220, S0_x2=130, S0_y2=190, S0_x3=130, S0_y3=250, qucs_mirrored=0, qucs_rotated=0 *) _BJT #(.Type(npn),.Is(2e-15),.Nf(1),.Nr(1),.Ikf(0.01),.Ikr(0.10),.Vaf(100),.Var(10),.Ise(0),.Ne(2.0),.Isc(0),.Nc(2.0),.Bf(300),.Br(5.67),.Rbm(0),.Irb(0),.Rc(0),.Re(0),.Rb(0),.Cje(0),.Vje(0.75),.Mje(0.33),.Cjc(0),.Vjc(0.75),.Mjc(0.33),.Xcjc(1.0),.Cjs(0),.Vjs(0.75),.Mjs(0),.Fc(0.5),.Tf(0.0),.Xtf(0.0),.Vtf(0.0),.Itf(0.0),.Tr(0.0),.Temp(26.85),.Kf(0.0),.Af(1.0),.Ffe(1.0),.Kb(0.0),.Ab(1.0),.Fb(1.0),.Ptf(0.0),.Xtb(0.0),.Xti(3.0),.Eg(1.11),.Tnom(26.85),.Area(1.0)) btgn1 ( n_100_220, n_130_190, n_130_250 );
    (* S0_x1=20, S0_y1=220, S0_x2=80, S0_y2=220, qucs_mirrored=0, qucs_rotated=0 *) L #(.L(3 nH),.I()) L1 ( n_20_220, n_80_220 );
    (* S0_x1=220, S0_y1=280, S0_x2=160, S0_y2=280, qucs_mirrored=0, qucs_rotated=2 *) R #(.R(140),.Temp(26.85),.Tc1(0.0),.Tc2(0.0),.Tnom(26.85)) RF1 ( n_220_280, n_160_280 );
    (* S0_x1=220, S0_y1=230, S0_x2=250, S0_y2=200, S0_x3=250, S0_y3=260, qucs_mirrored=0, qucs_rotated=0 *) _BJT #(.Type(npn),.Is(1e-15),.Nf(1),.Nr(1),.Ikf(0.01),.Ikr(0.10),.Vaf(100),.Var(10),.Ise(0),.Ne(2.0),.Isc(0),.Nc(2.0),.Bf(300),.Br(5.67),.Rbm(0),.Irb(0),.Rc(0),.Re(0),.Rb(0),.Cje(0),.Vje(0.75),.Mje(0.33),.Cjc(0),.Vjc(0.75),.Mjc(0.33),.Xcjc(1.0),.Cjs(0),.Vjs(0.75),.Mjs(0),.Fc(0.5),.Tf(0.0),.Xtf(0.0),.Vtf(0.0),.Itf(0.0),.Tr(0.0),.Temp(26.85),.Kf(0.0),.Af(1.0),.Ffe(1.0),.Kb(0.0),.Ab(1.0),.Fb(1.0),.Ptf(0.0),.Xtb(0.0),.Xti(3.0),.Eg(1.11),.Tnom(26.85),.Area(1.0)) btgn4 ( n_220_230, n_250_200, n_250_260 );
    (* S0_x1=280, S0_y1=130, S0_x2=250, S0_y2=100, S0_x3=250, S0_y3=160, qucs_mirrored=1, qucs_rotated=2 *) _BJT #(.Type(npn),.Is(1e-15),.Nf(1),.Nr(1),.Ikf(0.01),.Ikr(0.10),.Vaf(100),.Var(10),.Ise(0),.Ne(2.0),.Isc(0),.Nc(2.0),.Bf(300),.Br(5.67),.Rbm(0),.Irb(0),.Rc(0),.Re(0),.Rb(0),.Cje(0),.Vje(0.75),.Mje(0.33),.Cjc(0),.Vjc(0.75),.Mjc(0.33),.Xcjc(1.0),.Cjs(0),.Vjs(0.75),.Mjs(0),.Fc(0.5),.Tf(0.0),.Xtf(0.0),.Vtf(0.0),.Itf(0.0),.Tr(0.0),.Temp(26.85),.Kf(0.0),.Af(1.0),.Ffe(1.0),.Kb(0.0),.Ab(1.0),.Fb(1.0),.Ptf(0.0),.Xtb(0.0),.Xti(3.0),.Eg(1.11),.Tnom(26.85),.Area(1.0)) btgn3 ( n_280_130, n_250_100, n_250_160 );
    (* S0_x1=130, S0_y1=370, qucs_mirrored=0, qucs_rotated=0 *) GND #() \*  ( n_130_370 );
    (* S0_x1=300, S0_y1=410, S0_x2=240, S0_y2=410, qucs_mirrored=0, qucs_rotated=2 *) R #(.R(200),.Temp(26.85),.Tc1(0.0),.Tc2(0.0),.Tnom(26.85)) RF2 ( n_300_410, n_240_410 );
    (* qucs_mirrored=0, qucs_rotated=0 *) Eqn #(.Gain(abs(Out.v/In.v)),.Export(yes)) Eqn1 (  );
    (* S0_x1=40, S0_y1=120, qucs_mirrored=0, qucs_rotated=0 *) GND #() \*  ( n_40_120 );
    (* S0_x1=40, S0_y1=60, S0_x2=40, S0_y2=120, qucs_mirrored=0, qucs_rotated=1 *) Vdc #(.U(6 V)) VCC ( n_40_60, n_40_120 );
    (* S0_x1=-50, S0_y1=320, qucs_mirrored=0, qucs_rotated=0 *) GND #() \*  ( n_m50_320 );
    (* S0_x1=-50, S0_y1=260, S0_x2=-50, S0_y2=320, qucs_mirrored=0, qucs_rotated=1 *) Vac #(.U(50u),.f(1 GHz),.Phase(0),.Theta(0)) V1 ( n_m50_260, n_m50_320 );
    (* S0_x1=-40, S0_y1=220, S0_x2=20, S0_y2=220, qucs_mirrored=0, qucs_rotated=0 *) DCBlock #(.C(1 uF)) C1 ( n_m40_220, n_20_220 );
    ...
    (* S0_x1=350, S0_y1=270, S0_x2=350, S0_y2=210, qucs_mirrored=0, qucs_rotated=1 *) R #(.R(140),.Temp(26.85),.Tc1(0.0),.Tc2(0.0),.Tnom(26.85)) R3 ( n_350_270, n_350_210 );
    (* S0_x1=320, S0_y1=170, S0_x2=350, S0_y2=140, S0_x3=350, S0_y3=200, qucs_mirrored=0, qucs_rotated=0 *) _BJT #(.Type(npn),.Is(1e-15),.Nf(1),.Nr(1),.Ikf(0.01),.Ikr(0.10),.Vaf(100),.Var(10),.Ise(0),.Ne(2.0),.Isc(0),.Nc(2.0),.Bf(300),.Br(5.67),.Rbm(0),.Irb(0),.Rc(0),.Re(0),.Rb(0),.Cje(0),.Vje(0.75),.Mje(0.33),.Cjc(0),.Vjc(0.75),.Mjc(0.33),.Xcjc(1.0),.Cjs(0),.Vjs(0.75),.Mjs(0),.Fc(0.5),.Tf(0.0),.Xtf(0.0),.Vtf(0.0),.Itf(0.0),.Tr(0.0),.Temp(26.85),.Kf(0.0),.Af(1.0),.Ffe(1.0),.Kb(0.0),.Ab(1.0),.Fb(1.0),.Ptf(0.0),.Xtb(0.0),.Xti(3.0),.Eg(1.11),.Tnom(26.85),.Area(1.0)) btgn6 ( n_320_170, n_350_140, n_350_200 );
    (* S0_x1=440, S0_y1=340, S0_x2=440, S0_y2=280, qucs_mirrored=0, qucs_rotated=1 *) R #(.R(12),.Temp(26.85),.Tc1(0.0),.Tc2(0.0),.Tnom(26.85)) RE2 ( n_440_340, n_440_280 );
    (* S0_x1=410, S0_y1=390, S0_x2=440, S0_y2=360, S0_x3=440, S0_y3=420, qucs_mirrored=0, qucs_rotated=0 *) _BJT #(.Type(npn),.Is(1e-15),.Nf(1),.Nr(1),.Ikf(0.01),.Ikr(0.10),.Vaf(100),.Var(10),.Ise(0),.Ne(2.0),.Isc(0),.Nc(2.0),.Bf(300),.Br(5.67),.Rbm(0),.Irb(0),.Rc(0),.Re(0),.Rb(0),.Cje(0),.Vje(0.75),.Mje(0.33),.Cjc(0),.Vjc(0.75),.Mjc(0.33),.Xcjc(1.0),.Cjs(0),.Vjs(0.75),.Mjs(0),.Fc(0.5),.Tf(0.0),.Xtf(0.0),.Vtf(0.0),.Itf(0.0),.Tr(0.0),.Temp(26.85),.Kf(0.0),.Af(1.0),.Ffe(1.0),.Kb(0.0),.Ab(1.0),.Fb(1.0),.Ptf(0.0),.Xtb(0.0),.Xti(3.0),.Eg(1.11),.Tnom(26.85),.Area(1.0)) btgn5 ( n_410_390, n_440_360, n_440_420 );
    (* S0_x1=410, S0_y1=200, S0_x2=440, S0_y2=170, S0_x3=440, S0_y3=230, qucs_mirrored=0, qucs_rotated=0 *) _BJT #(.Type(npn),.Is(1e-15),.Nf(1),.Nr(1),.Ikf(0.01),.Ikr(0.10),.Vaf(100),.Var(10),.Ise(0),.Ne(2.0),.Isc(0),.Nc(2.0),.Bf(300),.Br(5.67),.Rbm(0),.Irb(0),.Rc(0),.Re(0),.Rb(0),.Cje(0),.Vje(0.75),.Mje(0.33),.Cjc(0),.Vjc(0.75),.Mjc(0.33),.Xcjc(1.0),.Cjs(0),.Vjs(0.75),.Mjs(0),.Fc(0.5),.Tf(0.0),.Xtf(0.0),.Vtf(0.0),.Itf(0.0),.Tr(0.0),.Temp(26.85),.Kf(0.0),.Af(1.0),.Ffe(1.0),.Kb(0.0),.Ab(1.0),.Fb(1.0),.Ptf(0.0),.Xtb(0.0),.Xti(3.0),.Eg(1.11),.Tnom(26.85),.Area(1.0)) btgn2 ( n_410_200, n_440_170, n_440_230 );
    (* S0_x1=440, S0_y1=110, S0_x2=440, S0_y2=50, qucs_mirrored=1, qucs_rotated=1 *) R #(.R(225),.Temp(26.85),.Tc1(0.0),.Tc2(0.0),.Tnom(26.85)) R2 ( n_440_110, n_440_50 );
    (* S0_x1=440, S0_y1=420, qucs_mirrored=0, qucs_rotated=0 *) GND #() \*  ( n_440_420 );
    (* S0_x1=530, S0_y1=130, S0_x2=470, S0_y2=130, qucs_mirrored=0, qucs_rotated=2 *) R #(.R(10),.Temp(26.85),.Tc1(0.0),.Tc2(0.0),.Tnom(26.85)) R0 ( n_530_130, n_470_130 );
    (* S0_x1=590, S0_y1=130, S0_x2=650, S0_y2=130, qucs_mirrored=0, qucs_rotated=0 *) DCBlock #(.C(1 uF)) C2 ( n_590_130, n_650_130 );
    (* S0_x1=530, S0_y1=130, S0_x2=590, S0_y2=130, qucs_mirrored=0, qucs_rotated=0 *) L #(.L(3 nH),.I()) L2 ( n_530_130, n_590_130 );
    (* S0_x1=650, S0_y1=250, qucs_mirrored=0, qucs_rotated=0 *) GND #() \*  ( n_650_250 );
    (* S0_x1=650, S0_y1=250, S0_x2=650, S0_y2=190, qucs_mirrored=0, qucs_rotated=1 *) R #(.R(1k),.Temp(26.85),.Tc1(0.0),.Tc2(0.0),.Tnom(26.85)) RL ( n_650_250, n_650_190 );
