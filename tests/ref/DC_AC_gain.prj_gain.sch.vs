// VS::printSubckt main
module main();
Vac #(.U(1 uV), .f(2 kHz), .Phase(0), .Theta(0), .$ty(18), .$tx(18), .$xposition(40), .$yposition(230), .$vflip(1), .$hflip(1)) V4(net_40_200, net_40_260);
GND #(.$xposition(40), .$yposition(270), .$vflip(1), .$hflip(1)) anonymous_gnd_hack_0(net_40_270);
R #(.R(50k), .Temp(26.85), .Tc1(0.0), .Tc2(0.0), .Tnom(26.85), .Symbol(european), .$ty(-26), .$tx(-26), .$xposition(260), .$yposition(310), .$vflip(1), .$hflip(1)) R2(net_290_310, net_230_310);
GND #(.$xposition(100), .$yposition(310), .$vflip(1), .$hflip(1)) anonymous_gnd_hack_1(net_100_310);
R #(.R(100k), .Temp(26.85), .Tc1(0.0), .Tc2(0.0), .Tnom(26.85), .Symbol(european), .$ty(13), .$tx(13), .$xposition(360), .$yposition(270), .$vflip(1), .$hflip(1)) R1(net_360_300, net_360_240);
GND #(.$xposition(360), .$yposition(300), .$vflip(1), .$hflip(1)) anonymous_gnd_hack_2(net_360_300);
GND #(.$xposition(130), .$yposition(150), .$vflip(1), .$hflip(1)) anonymous_gnd_hack_3(net_130_150);
Vdc #(.U(2.5 V), .$ty(18), .$tx(18), .$xposition(130), .$yposition(120), .$vflip(1), .$hflip(1)) V3(net_130_90, net_130_150);
GND #(.$xposition(210), .$yposition(400), .$vflip(1), .$hflip(1)) anonymous_gnd_hack_4(net_210_400);
Vdc #(.U(-2.5 V), .$ty(18), .$tx(18), .$xposition(210), .$yposition(370), .$vflip(1), .$hflip(1)) V6(net_210_340, net_210_400);
//AC1
//DC1
Eqn #(.Gain(dB(Output.v/Input.v)), .Phase(phase(Output.v/Input.v)), .Export(yes), .$ty(-23), .$tx(-23), .$xposition(360), .$yposition(370), .$vflip(1), .$hflip(1)) Eqn1();
Sub #(.$tx(25), .$ty(-51), .File(singleOPV.sch), .$xposition(200), .$yposition(220), .$vflip(1), .$hflip(1)) OPV1(net_160_240, net_160_200, net_210_170, net_210_270, net_260_220);
R #(.R(1.7k), .Temp(26.85), .Tc1(0.0), .Tc2(0.0), .Tnom(26.85), .Symbol(european), .$ty(-26), .$tx(-26), .$xposition(130), .$yposition(310), .$vflip(1), .$hflip(1)) R3(net_160_310, net_100_310);
...
wire #(.$tx(70), .$ty(-50), .netname(Output), .$xposition(290), .$yposition(220), .$vflip(1), .$hflip(1)) noname(net_290_220, net_360_220);
...
wire #(.$tx(-57), .$ty(-30), .netname(Input), .$xposition(40), .$yposition(200), .$vflip(1), .$hflip(1)) noname(net_40_200, net_40_200);
