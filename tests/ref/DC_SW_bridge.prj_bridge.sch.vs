(* qucs_ViewX1=0, qucs_ViewY1=0, qucs_ViewX2=800, qucs_ViewY2=800, qucs_Scale=1, qucs_tmpViewX1=0, qucs_tmpViewY1=0, qucs_GridX=10, qucs_GridY=10, qucs_GridOn=1, qucs_DataSet="bridge.dat", qucs_DataDisplay="bridge.dpl", qucs_SimOpenDpl=1, qucs_Script="bridge.m", qucs_SimRunScript=0, qucs_showFrame=0, qucs_FrameText0="Title", qucs_FrameText1="Drawn By:", qucs_FrameText2="Date:", qucs_FrameText3="Revision:" *) module bridge();
    ...
    (* qucs_mirrored=0, qucs_rotated=0, qucs_visible="111111", S0_x=300, S0_y=370 *) \.SW  #(.Sim(DC1),.Type(lin),.Start(Rmeasure),.Stop(10 Ohm),.Points(1 kOhm),.Points(100)) SW1 (  );
    (* qucs_mirrored=0, qucs_rotated=0, qucs_visible="111111", S0_x=410, S0_y=370 *) \.SW  #(.Sim(SW1),.Type(lin),.Start(Rbranch),.Stop(200 Ohm),.Points(1 kOhm),.Points(4)) SW2 (  );
    (* qucs_mirrored=0, qucs_rotated=0, qucs_visible="10", S0_x=500, S0_y=360 *) Eqn #(.Umeasure(500 * abs(Pr1.I)),.Export(yes)) Eqn1 (  );
