...
EDD #(.$xposition(300), .$yposition(270), .$vflip(1), .$hflip(1), .$tx(-238), .$ty(-238), .Type(explicit), .Branches(4), .I1(V1<-VBR+50*Vt ? -IsT*(1+exp(-(VBR+V1)/Vt)) + GMIN*V1 : 0), .Q1(0), .p(V1>=-VBR+50*Vt && V1<-5*Vt ? -IsT+GMIN*V1 : V1>=-5*Vt ? IsT*(exp(V1/(N*Vt))-1) + GMIN*V1 : 0), .p(0), .p(V1-VT0>0 ? Beta*(V1-VT0)^2*(1+Lambda*V3)*tanh(Alpha*V3) : 0), .p(CDS*V3 + TAU*I3), .p(0), .p(CGS*V4)) D1(net_300_240, net_300_300);
...
place #(.$xposition(300), .$yposition(240), .$vflip(1), .$hflip(1)) net_300_240(net_300_240);
place #(.$xposition(300), .$yposition(300), .$vflip(1), .$hflip(1)) net_300_300(net_300_300);
