...
wire #(.$xposition(380), .$yposition(150), .$vflip(1), .$hflip(1), .$angle(270)) noname(net_380_150, net_380_160);
wire #(.$xposition(380), .$yposition(60), .$vflip(1), .$hflip(1), .$angle(270)) noname(net_380_60, net_380_90);
wire #(.$xposition(210), .$yposition(60), .$vflip(1), .$hflip(1), .$angle(0)) noname(net_210_60, net_290_60);
wire #(.$xposition(80), .$yposition(120), .$vflip(1), .$hflip(1), .$angle(270)) noname(net_80_120, net_80_130);
wire #(.$xposition(80), .$yposition(120), .$vflip(1), .$hflip(1), .$angle(0)) noname(net_80_120, net_180_120);
wire #(.$xposition(210), .$yposition(60), .$vflip(1), .$hflip(1), .$angle(270)) noname(net_210_60, net_210_80);
wire #(.$xposition(350), .$yposition(60), .$vflip(1), .$hflip(1), .$angle(0)) noname(net_350_60, net_380_60);
