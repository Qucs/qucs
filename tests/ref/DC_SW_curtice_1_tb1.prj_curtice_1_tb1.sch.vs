// VS::printSubckt main
module main();
Vdc #(.U(Vgs), .$ty(18), .$tx(18), .$xposition(80), .$yposition(160), .$vflip(1), .$hflip(1)) V2(net_80_130, net_80_190);
GND #(.$xposition(80), .$yposition(190), .$vflip(1), .$hflip(1)) anonymous_gnd_hack_0(net_80_190);
//DC1
Eqn #(.Id(-V1.I), .Export(yes), .$ty(-32), .$tx(-32), .$xposition(70), .$yposition(390), .$vflip(1), .$hflip(1)) Eqn1();
GND #(.$xposition(380), .$yposition(160), .$vflip(1), .$hflip(1)) anonymous_gnd_hack_1(net_380_160);
Vdc #(.U(Vds), .$ty(18), .$tx(18), .$xposition(380), .$yposition(120), .$vflip(1), .$hflip(1)) V1(net_380_90, net_380_150);
GND #(.$xposition(210), .$yposition(160), .$vflip(1), .$hflip(1)) anonymous_gnd_hack_2(net_210_160);
IProbe #(.$ty(-26), .$tx(-26), .$xposition(320), .$yposition(60), .$vflip(-1), .$hflip(1)) Pr1(net_350_60, net_290_60);
Sub #(.$tx(20), .$ty(-46), .File(curtice_1.sch), .RG(1m), .RD(1m), .RS(1m), .VBR(10e10), .LG(1e-15), .LD(1e-15), .LS(1e-15), .IS(10f), .N(1), .XTI(0), .EG(1.11), .Beta(3m), .Lambda(40m), .VT0(-6), .Temp(27), .Alpha(0.8), .CDS(300f), .TAU(10p), .RIN(1m), .CGS(300f), .CGD(300f), .Tnom(27), .$xposition(210), .$yposition(120), .$vflip(1), .$hflip(1)) Curtice1(net_210_160, net_180_120, net_210_80);
