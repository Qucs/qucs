(* qucs_ViewX1=0, qucs_ViewY1=0, qucs_ViewX2=658, qucs_ViewY2=570, qucs_Scale=1, qucs_tmpViewX1=0, qucs_tmpViewY1=0, qucs_GridX=10, qucs_GridY=10, qucs_GridOn=1, qucs_DataSet="fgummel.dat", qucs_DataDisplay="fgummel.dpl", qucs_SimOpenDpl=1, qucs_Script="fgummel.m", qucs_SimRunScript=0, qucs_showFrame=0, qucs_FrameText0="Titel", qucs_FrameText1="Gezeichnet von:", qucs_FrameText2="Datum:", qucs_FrameText3="Revision:" *) module fgummel();
    ...
    wire n_360_190;
    wire n_450_50;
    (* S0_x1=40, S0_y1=130, S0_x2=40, S0_y2=190, qucs_mirroredX=0, qucs_rotated=1 *) Vdc #(.U(Vbe)) VBE ( n_40_130, n_40_190 );
    ...
    (* , qucs_mirroredX=0, qucs_rotated=0 *) Eqn #(.Ib(-VBE.I),.Beta(Ic/Ib),.Ic(-VCE.I),.Isub(-VSUB.I),.Export(yes)) Eqn1 (  );
    (* , qucs_mirroredX=0, qucs_rotated=0 *) \.SW  #(.Sim(DC1),.Type(lin),.Start(Vbe),.Stop(0.1),.Points(1.1),.Points(201)) SW1 (  );
