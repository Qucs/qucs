(* qucs_ViewX1=0, qucs_ViewY1=0, qucs_ViewX2=800, qucs_ViewY2=800, qucs_Scale=1, qucs_tmpViewX1=-200, qucs_tmpViewY1=-200, qucs_GridX=10, qucs_GridY=10, qucs_GridOn=1, qucs_DataSet="microstrip.dat", qucs_DataDisplay="microstrip.dpl", qucs_SimOpenDpl=1, qucs_Script="microstrip.m", qucs_SimRunScript=0, qucs_showFrame=0, qucs_FrameText0="Title", qucs_FrameText1="Drawn By:", qucs_FrameText2="Date:", qucs_FrameText3="Revision:" *) module microstrip();
    ...
    wire n_550_130;
    wire n_100_130;
    (* qucs_mirrored=0, qucs_rotated=1, qucs_visible="11000", S0_x1=340, S0_y1=320, S0_x2=340, S0_y2=380 *) Pac #(.Num(3),.Z(50 Ohm),.P(0 dBm),.f(1 GHz),.Temp(26.85)) P3 ( n_340_320, n_340_380 );
    (* qucs_mirrored=0, qucs_rotated=0, qucs_visible="", S0_x1=340, S0_y1=380 *) GND #() \*  ( n_340_380 );
    (* qucs_mirrored=0, qucs_rotated=0, qucs_visible="", S0_x1=240, S0_y1=290 *) GND #() \*  ( n_240_290 );
    (* qucs_mirrored=0, qucs_rotated=1, qucs_visible="11000", S0_x1=550, S0_y1=140, S0_x2=550, S0_y2=200 *) Pac #(.Num(2),.Z(50 Ohm),.P(0 dBm),.f(1 GHz),.Temp(26.85)) P2 ( n_550_140, n_550_200 );
    (* qucs_mirrored=0, qucs_rotated=0, qucs_visible="", S0_x1=550, S0_y1=200 *) GND #() \*  ( n_550_200 );
