...
wire #(.$xposition(80), .$yposition(40), .$vflip(1), .$hflip(1), .$angle(0)) noname(net_80_40, net_140_40);
wire #(.$xposition(80), .$yposition(40), .$vflip(1), .$hflip(1), .$angle(270)) noname(net_80_40, net_80_60);
wire #(.$xposition(120), .$yposition(100), .$vflip(1), .$hflip(1), .$angle(270)) noname(net_120_100, net_120_130);
wire #(.$xposition(120), .$yposition(100), .$vflip(1), .$hflip(1), .$angle(0)) noname(net_120_100, net_140_100);
wire #(.$xposition(300), .$yposition(40), .$vflip(1), .$hflip(1), .$angle(270)) noname(net_300_40, net_300_60);
wire #(.$xposition(200), .$yposition(40), .$vflip(1), .$hflip(1), .$angle(0)) noname(net_200_40, net_300_40);
wire #(.$xposition(260), .$yposition(100), .$vflip(1), .$hflip(1), .$angle(270)) noname(net_260_100, net_260_150);
wire #(.$xposition(200), .$yposition(100), .$vflip(1), .$hflip(1), .$angle(0)) noname(net_200_100, net_260_100);
