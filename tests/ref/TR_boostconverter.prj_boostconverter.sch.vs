(* qucs_ViewX1=0, qucs_ViewY1=0, qucs_ViewX2=800, qucs_ViewY2=868, qucs_Scale=1, qucs_tmpViewX1=0, qucs_tmpViewY1=0, qucs_GridX=10, qucs_GridY=10, qucs_GridOn=1, qucs_DataSet="boostconverter.dat", qucs_DataDisplay="boostconverter.dpl", qucs_SimOpenDpl=0, qucs_Script="boostconverter.m", qucs_SimRunScript=0, qucs_showFrame=0, qucs_FrameText0="Title", qucs_FrameText1="Drawn By:", qucs_FrameText2="Date:", qucs_FrameText3="Revision:" *) module boostconverter();
    ...
    (* qucs_mirrored=0, qucs_rotated=0, qucs_visible="110", S0_x=400, S0_y=300 *) Eqn #(.Tmax(Bperiod*20),.Tstep(Bperiod/1000),.Export(yes)) Eqn1 (  );
    ...
    (* qucs_mirrored=0, qucs_rotated=0, qucs_visible="111110", S0_x=580, S0_y=520 *) Eqn #(.Bfreq(40k),.Bperiod(1/Bfreq),.Bduty(50),.Ton(Bperiod*Bduty/100),.Toff(Bperiod-Ton),.Export(yes)) Eqn2 (  );
    ...
    (* S0_x1=220, S0_y1=170, S0_x2=220, S0_y2=270, S0_qucs_x=170, S0_qucs_y=260, S0_qucs_delta=76 *) net #() ctrl ( n_220_170, n_220_270, ctrl );
    (* S0_x1=380, S0_y1=150, S0_x2=460, S0_y2=150, S0_qucs_x=410, S0_qucs_y=120, S0_qucs_delta=15 *) net #() dio ( n_380_150, n_460_150, dio );
    ...
    (* S0_x1=560, S0_y1=150, S0_x2=660, S0_y2=150, S0_qucs_x=640, S0_qucs_y=120, S0_qucs_delta=62 *) net #() out ( n_560_150, n_660_150, out );
