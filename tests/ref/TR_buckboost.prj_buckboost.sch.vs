(* qucs_ViewX1=-3, qucs_ViewY1=10, qucs_ViewX2=1366, qucs_ViewY2=676, qucs_Scale=1, qucs_tmpViewX1=18, qucs_tmpViewY1=0, qucs_GridX=10, qucs_GridY=10, qucs_GridOn=1, qucs_DataSet="buckboost.dat", qucs_DataDisplay="buckboost.dpl", qucs_SimOpenDpl=0, qucs_Script="buckboost.m", qucs_SimRunScript=0, qucs_showFrame=0, qucs_FrameText0="Title", qucs_FrameText1="Drawn By:", qucs_FrameText2="Date:", qucs_FrameText3="Revision:" *) module buckboost();
    ...
    (* S0_x1=330, S0_y1=220, S0_x2=330, S0_y2=160, qucs_mirrored=0, qucs_rotated=1 *) L #(.L(47uH),.I(0)) L1 ( n_330_220, n_330_160 );
    (* S0_x1=380, S0_y1=140, S0_x2=440, S0_y2=140, qucs_mirrored=0, qucs_rotated=0 *) Diode #(.Is(1e-12 A),.N(1),.Cj0(10 fF),.M(0.5),.Vj(0.7 V),.Fc(0.5),.Cp(0.0 fF),.Isr(0.0),.Nr(2.0),.Rs(0.0 Ohm),.Tt(0.0 ps),.Ikf(0),.Kf(0.0),.Af(1.0),.Ffe(1.0),.Bv(0),.Ibv(1 mA),.Temp(26.85),.Xti(3.0),.Eg(1.11),.Tbv(0.0),.Trs(0.0),.Ttt1(0.0),.Ttt2(0.0),.Tm1(0.0),.Tm2(0.0),.Tnom(26.85),.Area(1.0),.Symbol(normal)) D1 ( n_380_140, n_440_140 );
    (* S0_x1=640, S0_y1=220, S0_x2=640, S0_y2=160, qucs_mirrored=0, qucs_rotated=1 *) R #(.R(10),.Temp(26.85),.Tc1(0.0),.Tc2(0.0),.Tnom(26.85)) R1 ( n_640_220, n_640_160 );
