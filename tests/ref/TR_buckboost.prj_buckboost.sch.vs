...
//TR1
L #(.L(47uH), .I(0), .$ty(10), .$tx(10), .$xposition(330), .$yposition(190), .$vflip(1), .$hflip(1), .$angle(90)) L1(net_330_220, net_330_160);
Diode #(.Is(1e-12 A), .N(1), .Cj0(10 fF), .M(0.5), .Vj(0.7 V), .Fc(0.5), .Cp(0.0 fF), .Isr(0.0), .Nr(2.0), .Rs(0.0 Ohm), .Tt(0.0 ps), .Ikf(0), .Kf(0.0), .Af(1.0), .Ffe(1.0), .Bv(0), .Ibv(1 mA), .Temp(26.85), .Xti(3.0), .Eg(1.11), .Tbv(0.0), .Trs(0.0), .Ttt1(0.0), .Ttt2(0.0), .Tm1(0.0), .Tm2(0.0), .Tnom(26.85), .Area(1.0), .Symbol(normal), .$ty(-26), .$tx(-26), .$xposition(410), .$yposition(140), .$vflip(1), .$hflip(1), .$angle(0)) D1(net_380_140, net_440_140);
R #(.R(10), .Temp(26.85), .Tc1(0.0), .Tc2(0.0), .Tnom(26.85), .Symbol(european), .$ty(15), .$tx(15), .$xposition(640), .$yposition(190), .$vflip(1), .$hflip(1), .$angle(90)) R1(net_640_220, net_640_160);
Eqn #(.Tmax(Bperiod*20), .Tstep(Bperiod/1000), .Export(yes), .$ty(-35), .$tx(-35), .$xposition(360), .$yposition(290), .$vflip(1), .$hflip(1), .$angle(0)) Eqn2();
Eqn #(.Bfreq(40k), .Bperiod(1/Bfreq), .Bduty(30), .Ton(Bperiod*Bduty/100), .Toff(Bperiod-Ton), .Export(yes), .$ty(-35), .$tx(-35), .$xposition(520), .$yposition(510), .$vflip(1), .$hflip(1), .$angle(0)) Eqn1();
