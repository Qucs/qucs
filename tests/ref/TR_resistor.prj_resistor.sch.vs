// VS::printSubckt main
module main();
GND #(.$xposition(660), .$yposition(370), .$vflip(1), .$hflip(1)) anonymous_gnd_hack_0(net_660_370);
//TR1
R #(.R(50 Ohm), .Temp(26.85), .Tc1(0.0), .Tc2(0.0), .Tnom(26.85), .Symbol(european), .$ty(-26), .$tx(-26), .$xposition(610), .$yposition(270), .$vflip(1), .$hflip(1)) R2(net_580_270, net_640_270);
R #(.R(50 Ohm), .Temp(26.85), .Tc1(0.0), .Tc2(0.0), .Tnom(26.85), .Symbol(european), .$ty(-26), .$tx(-26), .$xposition(530), .$yposition(270), .$vflip(1), .$hflip(1)) R1(net_500_270, net_560_270);
Vac #(.U(10 V), .f(1kHz), .Phase(0), .Theta(0), .$ty(18), .$tx(18), .$xposition(450), .$yposition(320), .$vflip(1), .$hflip(1)) V1(net_450_290, net_450_350);
...
wire #(.$tx(50), .$ty(-30), .netname(Vin), .$xposition(450), .$yposition(270), .$vflip(1), .$hflip(1)) noname(net_450_270, net_500_270);
wire #(.$tx(40), .$ty(-30), .netname(Vout), .$xposition(560), .$yposition(270), .$vflip(1), .$hflip(1)) noname(net_560_270, net_580_270);
