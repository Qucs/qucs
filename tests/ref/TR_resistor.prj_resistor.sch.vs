...
wire #(.$xposition(450), .$yposition(350), .$vflip(1), .$hflip(1), .$angle(270)) noname(net_450_350, net_450_360);
wire #(.$xposition(450), .$yposition(360), .$vflip(1), .$hflip(1), .$angle(0)) noname(net_450_360, net_660_360);
wire #(.$xposition(660), .$yposition(360), .$vflip(1), .$hflip(1), .$angle(270)) noname(net_660_360, net_660_370);
wire #(.$xposition(660), .$yposition(270), .$vflip(1), .$hflip(1), .$angle(270)) noname(net_660_270, net_660_360);
wire #(.$xposition(450), .$yposition(270), .$vflip(1), .$hflip(1), .$angle(270)) noname(net_450_270, net_450_290);
wire #(.$tx(50), .$ty(-30), .netname(Vin), .$xposition(450), .$yposition(270), .$vflip(1), .$hflip(1), .$angle(0)) noname(net_450_270, net_500_270);
wire #(.$tx(40), .$ty(-30), .netname(Vout), .$xposition(560), .$yposition(270), .$vflip(1), .$hflip(1), .$angle(0)) noname(net_560_270, net_580_270);
wire #(.$xposition(640), .$yposition(270), .$vflip(1), .$hflip(1), .$angle(0)) noname(net_640_270, net_660_270);
