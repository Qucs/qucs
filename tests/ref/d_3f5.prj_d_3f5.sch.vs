...
wire #(.$xposition(440), .$yposition(300), .$vflip(1), .$hflip(1), .$angle(0)) noname(net_440_300, net_490_300);
wire #(.$xposition(330), .$yposition(300), .$vflip(1), .$hflip(1), .$angle(0)) noname(net_330_300, net_380_300);
wire #(.$xposition(330), .$yposition(300), .$vflip(1), .$hflip(1), .$angle(270)) noname(net_330_300, net_330_310);
