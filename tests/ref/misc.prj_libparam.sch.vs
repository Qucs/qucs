...
wire #(.$vscale(80), .$xposition(140), .$yposition(200), .$vflip(1), .$hflip(1), .$angle(0)) noname(net_140_200, net_220_200);
...
wire #(.$vscale(0), .$xposition(340), .$yposition(200), .$vflip(1), .$hflip(1), .$angle(0)) noname(net_340_200, net_340_200);
// `ifdef QUCS_DIAGRAMS
// Tab
// Tab
// `endif
