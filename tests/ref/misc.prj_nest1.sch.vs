(* qucs_ViewX1=0, qucs_ViewY1=0, qucs_ViewX2=800, qucs_ViewY2=800, qucs_Scale=1, qucs_tmpViewX1=-200, qucs_tmpViewY1=-200, qucs_GridX=10, qucs_GridY=10, qucs_GridOn=1, qucs_DataSet="short_circuit.dat", qucs_DataDisplay="short_circuit.dpl", qucs_SimOpenDpl=1, qucs_Script="short_circuit.m", qucs_SimRunScript=0, qucs_showFrame=0, qucs_FrameText0="Title", qucs_FrameText1="Drawn By:", qucs_FrameText2="Date:", qucs_FrameText3="Revision:" *) module nest1(.P2(n_400_180), .P1(n_180_180));
    ...
    (* qucs_mirrored=0, qucs_rotated=0, qucs_Type="Sub", qucs_File="nest2.sch", qucs_visible="0", S0_x1=340, S0_y1=180 *) nest2 #() SC2 ( n_340_180 );
    (* qucs_mirrored=0, qucs_rotated=0, qucs_visible="000000", S0_x1=200, S0_y1=180, S0_x2=260, S0_y2=180 *) R #(.R(0 Ohm),.Temp(26.85),.Tc1(0.0),.Tc2(0.0),.Tnom(26.85)) R1 ( n_200_180, n_260_180 );
