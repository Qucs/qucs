...
Sub #(.$tx(-20), .$ty(14), .File(nest2.sch), .$xposition(310), .$yposition(180), .$vflip(1), .$hflip(1)) SC2(net_340_180, net_280_180);
R #(.R(0 Ohm), .Temp(26.85), .Tc1(0.0), .Tc2(0.0), .Tnom(26.85), .Symbol(US), .$ty(-26), .$tx(-26), .$xposition(230), .$yposition(180), .$vflip(1), .$hflip(1)) R1(net_200_180, net_260_180);
