...
R #(.$xposition(290), .$yposition(260), .$tx(-26), .$ty(-26), .R(0 Ohm), .Temp(26.85), .Tc1(0.0), .Tc2(0.0), .Tnom(26.85), .Symbol(US)) R1(net_260_260, net_320_260);
...
wire #(.$xposition(180), .$yposition(180)) noname(net_180_180, net_240_180);
wire #(.$xposition(240), .$yposition(260)) noname(net_240_260, net_260_260);
wire #(.$xposition(240), .$yposition(180)) noname(net_240_180, net_240_260);
wire #(.$xposition(320), .$yposition(260)) noname(net_320_260, net_340_260);
wire #(.$xposition(340), .$yposition(180)) noname(net_340_180, net_380_180);
wire #(.$xposition(340), .$yposition(180)) noname(net_340_180, net_340_260);
wire #(.$xposition(240), .$yposition(180)) noname(net_240_180, net_340_180);
