...
//DC1
Sub #(.$tx(-20), .$ty(14), .File(short_circuit.sch), .$xposition(250), .$yposition(200), .$vflip(1), .$hflip(1), .$angle(0)) SC1(net_280_200, net_220_200);
...
wire #(.$tx(70), .$ty(-30), .netname(in), .$xposition(140), .$yposition(200), .$vflip(1), .$hflip(1), .$angle(0)) noname(net_140_200, net_220_200);
...
wire #(.$tx(30), .$ty(-30), .netname(out), .$xposition(340), .$yposition(200), .$vflip(1), .$hflip(1), .$angle(0)) noname(net_340_200, net_340_200);
