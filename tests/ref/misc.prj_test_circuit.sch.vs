...
R #(.R(50 Ohm), .Temp(26.85), .Tc1(0.0), .Tc2(0.0), .Tnom(26.85), .Symbol(US), .$ty(15), .$tx(15), .$xposition(340), .$yposition(250), .$vflip(-1), .$hflip(1)) R1(net_340_220, net_340_280);
//DC1
Sub #(.$tx(-20), .$ty(14), .File(short_circuit.sch), .$xposition(250), .$yposition(200), .$vflip(1), .$hflip(1)) SC1(net_280_200, net_220_200);
...
wire #(.$tx(70), .$ty(-30), .netname(in), .$xposition(140), .$yposition(200), .$vflip(1), .$hflip(1)) noname(net_140_200, net_220_200);
...
wire #(.$tx(30), .$ty(-30), .netname(out), .$xposition(340), .$yposition(200), .$vflip(1), .$hflip(1)) noname(net_340_200, net_340_200);
