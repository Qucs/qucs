// VS::printSubckt main
module main();
Verilog #(.$tx(-20), .$ty(44), .File(verilogmodel.v), .A(1), .B(2), .$xposition(620), .$yposition(180), .$vflip(1), .$hflip(1)) BBBB(net_590_150, net_650_150, net_590_210);
...
Verilog #(.$tx(-20), .$ty(44), .File(verilogmodel.v), .A(NA(-2147483648)), .B(NA(-2147483648)), .$xposition(340), .$yposition(180)) AAAA(net_310_150, net_370_150, net_310_210);
