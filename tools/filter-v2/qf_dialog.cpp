...
FilterDialog::FilterDialog (QWidget * parent) : QDialog (parent)
{
  ...
  SubOrderCombo->addItem(tr( "b" ));
  SubOrderCombo->addItem(tr( "c" ));
  ...
  QVBoxLayout* lCboxes = new QVBoxLayout();
  lCboxes->addWidget(Cmin);
  lCboxes->addWidget(Cmax);
  lCboxes->addWidget(NoC);
  Cboxes->setLayout(lCboxes);
  ...
  QVBoxLayout* lLboxes = new QVBoxLayout();
  lLboxes->addWidget(Lmin);
  lLboxes->addWidget(Lmax);
  lLboxes->addWidget(NoL);
  Lboxes->setLayout(lLboxes);
